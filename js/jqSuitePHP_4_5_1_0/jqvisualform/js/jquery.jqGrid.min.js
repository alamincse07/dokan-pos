...
a(g).outerHeight()||e.prevRowHeight:e.prevRowHeight}catch(j){i=e.prevRowHeight}if(i){e.prevRowHeight=i;var l=d.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var m=Math.round(c.position().top)-g,k=m+c.height();i*=l;var n,o,q;if(k<b&&0>=m&&(void 0===d.lastpage||parseInt((k+g+i-1)/i,10)<=d.lastpage))o=parseInt((b-k+i-1)/i,10),0<=k||2>o||!0===d.scroll?(n=Math.round((k+g)/i)+1,m=-1):m=1;0<m&&(n=parseInt(g/i,10)+1,o=parseInt((g+b)/i,10)+2-n,q=!0);if(o&&(!d.lastpage||!(n>d.lastpage||1===d.lastpage||n===d.page&&
...
else if(void 0!==document.documentMode&&5>=document.documentMode)alert("Grid can not be used in this ('quirks') mode!");else{a(this).empty().attr("tabindex","0");this.p=d;this.p.useProp=!!a.fn.prop;var g,i;if(0===this.p.colNames.length)for(g=0;g<this.p.colModel.length;g++)this.p.colNames[g]=this.p.colModel[g].label||this.p.colModel[g].name;if(this.p.colNames.length!==this.p.colModel.length)alert(a.jgrid.errors.model);else{var j=a("<div class='ui-jqgrid-view'></div>"),k=a.jgrid.msie;b.p.direction=
a.trim(b.p.direction.toLowerCase());-1===a.inArray(b.p.direction,["ltr","rtl"])&&(b.p.direction="ltr");i=b.p.direction;a(j).insertBefore(this);a(this).removeClass("scroll").appendTo(j);var m=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(m).attr({id:"gbox_"+this.id,dir:i}).insertBefore(j);a(j).attr("id","gview_"+this.id).appendTo(m);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(j);a("<div class='loading ui-state-default ui-state-active' id='load_"+
this.id+"'>"+this.p.loadtext+"</div>").insertBefore(j);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var o=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},n=function(d,c,f,g,i,j){var l=b.p.colModel[d],m=l.align,k='style="',n=l.classes,o=l.name,q=[];m&&(k=k+("text-align:"+m+";"));l.hidden===true&&(k=k+"display:none;");if(c===0)k=k+("width: "+e.headers[d].width+"px;");else if(l.cellattr&&a.isFunction(l.cellattr))if((d=
...
f){b=p(a,b,d,e,"add");return'<td role="gridcell" '+n(d,c,b,e,a,f)+">"+b+"</td>"},t=function(a,d,c,e){e='<input role="checkbox" type="checkbox" id="jqg_'+b.p.id+"_"+a+'" class="cbox" name="jqg_'+b.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+n(d,c,"",null,a,true)+">"+e+"</td>"},r=function(a,b,d,c){d=(parseInt(d,10)-1)*parseInt(c,10)+1+b;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n(a,b,d,null,b,true)+">"+d+"</td>"},s=function(a){var d,c=[],e=0,
f;for(f=0;f<b.p.colModel.length;f++){d=b.p.colModel[f];if(d.name!=="cb"&&d.name!=="subgrid"&&d.name!=="rn"){c[e]=a==="local"?d.name:a==="xml"||a==="xmlstring"?d.xmlmap||d.name:d.jsonmap||d.name;if(b.p.keyIndex!==false&&d.key===true)b.p.keyName=c[e];e++}}return c},w=function(d){var c=b.p.remapColumns;if(!c||!c.length)c=a.map(b.p.colModel,function(a,b){return b});d&&(c=a.map(c,function(a){return a<d?null:a-d}));return c},v=function(b,d){var c;if(this.p.deepempty)a(this.rows).slice(1).remove();else{c=
this.rows.length>0?this.rows[0]:null;a(this.firstChild).empty().append(c)}if(b&&this.p.scroll){a(this.grid.bDiv.firstChild).css({height:"auto"});a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"});if(this.grid.bDiv.scrollTop!==0)this.grid.bDiv.scrollTop=0}if(d===true&&this.p.treeGrid){this.p.data=[];this.p._index={}}},y=function(){var d=b.p.data.length,c,e,f;c=b.p.rownumbers===true?1:0;e=b.p.multiselect===true?1:0;f=b.p.subGrid===true?1:0;c=b.p.keyIndex===false||b.p.loadonce===
true?b.p.localReader.id:b.p.colModel[b.p.keyIndex+e+f+c].name;for(e=0;e<d;e++){f=a.jgrid.getAccessor(b.p.data[e],c);f===void 0&&(f=""+(e+1));b.p._index[f]=e}},I=function(d,c,e,f,g,i){var h="-1",j="",l,c=c?"display:none;":"",e="ui-widget-content jqgrow ui-row-"+b.p.direction+(e?" "+e:"")+(i?" ui-state-highlight":""),i=a(b).triggerHandler("jqGridRowAttr",[f,g,d]);typeof i!=="object"&&(i=a.isFunction(b.p.rowattr)?b.p.rowattr.call(b,f,g,d):{});if(!a.isEmptyObject(i)){if(i.hasOwnProperty("id")){d=i.id;
delete i.id}if(i.hasOwnProperty("tabindex")){h=i.tabindex;delete i.tabindex}if(i.hasOwnProperty("style")){c=c+i.style;delete i.style}if(i.hasOwnProperty("class")){e=e+(" "+i["class"]);delete i["class"]}try{delete i.role}catch(m){}for(l in i)i.hasOwnProperty(l)&&(j=j+(" "+l+"="+i[l]))}return'<tr role="row" id="'+d+'" tabindex="'+h+'" class="'+e+'"'+(c===""?"":' style="'+c+'"')+j+">"},x=function(d,c,e,f,g){var i=new Date,h=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="xmlstring",j=b.p.xmlReader,
l=b.p.datatype==="local"?"local":"xml";if(h){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(a.isXMLDoc(d)){if(b.p.treeANode===-1&&!b.p.scroll){v.call(b,false,true);e=1}else e=e>1?e:1;var m=a(b),k,n,p=0,x,y=b.p.multiselect===true?1:0,E=0,Y,u=b.p.rownumbers===true?1:0,C,F=[],K,B={},G,z,L=[],T=b.p.altRows===true?b.p.altclass:"",H;if(b.p.subGrid===true){E=1;Y=a.jgrid.getMethod("addSubGridCell")}j.repeatitems||(F=s(l));C=b.p.keyIndex===false?a.isFunction(j.id)?j.id.call(b,d):j.id:
b.p.keyIndex;if(F.length>0&&!isNaN(C))C=b.p.keyName;l=(""+C).indexOf("[")===-1?F.length?function(b,d){return a(C,b).text()||d}:function(b,d){return a(j.cell,b).eq(C).text()||d}:function(a,b){return a.getAttribute(C.replace(/[\[\]]/g,""))||b};b.p.userData={};b.p.page=o(a.jgrid.getXmlData(d,j.page),b.p.page);b.p.lastpage=o(a.jgrid.getXmlData(d,j.total),1);b.p.records=o(a.jgrid.getXmlData(d,j.records));a.isFunction(j.userdata)?b.p.userData=j.userdata.call(b,d)||{}:a.jgrid.getXmlData(d,j.userdata,true).each(function(){b.p.userData[this.getAttribute("name")]=
a(this).text()});d=a.jgrid.getXmlData(d,j.root,true);(d=a.jgrid.getXmlData(d,j.row,true))||(d=[]);var A=d.length,D=0,O=[],P=parseInt(b.p.rowNum,10),R=b.p.scroll?a.jgrid.randId():1;if(A>0&&b.p.page<=0)b.p.page=1;if(d&&A){g&&(P=P*(g+1));var g=a.isFunction(b.p.afterInsertRow),S=false,J;if(b.p.grouping){S=b.p.groupingView.groupCollapse===true;J=a.jgrid.getMethod("groupingPrepare")}for(;D<A;){G=d[D];z=l(G,R+D);z=b.p.idPrefix+z;k=e===0?0:e+1;H=(k+D)%2===1?T:"";var N=L.length;L.push("");u&&L.push(r(0,D,
b.p.page,b.p.rowNum));y&&L.push(t(z,u,D,false));E&&L.push(Y.call(m,y+u,D+e));if(j.repeatitems){K||(K=w(y+E+u));var Q=a.jgrid.getXmlData(G,j.cell,true);a.each(K,function(a){var d=Q[this];if(!d)return false;x=d.textContent||d.text;B[b.p.colModel[a+y+E+u].name]=x;L.push(q(z,x,a+y+E+u,D+e,G,B))})}else for(k=0;k<F.length;k++){x=a.jgrid.getXmlData(G,F[k]);B[b.p.colModel[k+y+E+u].name]=x;L.push(q(z,x,k+y+E+u,D+e,G,B))}L[N]=I(z,S,H,B,G,false);L.push("</tr>");if(b.p.grouping){O=J.call(m,L,O,B,D);L=[]}if(h||
b.p.treeGrid===true){B._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(B);b.p._index[B._id_]=b.p.data.length-1}if(b.p.gridview===false){a("tbody:first",c).append(L.join(""));m.triggerHandler("jqGridAfterInsertRow",[z,B,G]);g&&b.p.afterInsertRow.call(b,z,B,G);L=[]}B={};p++;D++;if(p===P)break}}if(b.p.gridview===true){n=b.p.treeANode>-1?b.p.treeANode:0;if(b.p.grouping){m.jqGrid("groupingRender",O,b.p.colModel.length);O=null}else b.p.treeGrid===true&&n>0?a(b.rows[n]).after(L.join("")):a("tbody:first",
c).append(L.join(""))}if(b.p.subGrid===true)try{m.jqGrid("addSubGrid",y+u)}catch(aa){}b.p.totaltime=new Date-i;if(p>0&&b.p.records===0)b.p.records=A;L=null;if(b.p.treeGrid===true)try{m.jqGrid("setTreeNode",n+1,p+n+1)}catch(V){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=p;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,true);if(h){b.p.records=A;b.p.lastpage=Math.ceil(A/P)}f||b.updatepager(false,true);if(h)for(;p<A;){G=d[p];z=l(G,p+R);z=b.p.idPrefix+
z;if(j.repeatitems){K||(K=w(y+E+u));var M=a.jgrid.getXmlData(G,j.cell,true);a.each(K,function(a){var d=M[this];if(!d)return false;x=d.textContent||d.text;B[b.p.colModel[a+y+E+u].name]=x})}else for(k=0;k<F.length;k++){x=a.jgrid.getXmlData(G,F[k]);B[b.p.colModel[k+y+E+u].name]=x}B._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(B);b.p._index[B._id_]=b.p.data.length-1;B={};p++}}},C=function(d,c,e,f,g){var i=new Date;if(d){if(b.p.treeANode===-1&&!b.p.scroll){v.call(b,false,true);e=1}else e=e>1?e:
1;var h,j=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="jsonstring";if(j){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(b.p.datatype==="local"){c=b.p.localReader;h="local"}else{c=b.p.jsonReader;h="json"}var l=a(b),k=0,m,n,p,x=[],y=b.p.multiselect?1:0,E=b.p.subGrid===true?1:0,u,C=b.p.rownumbers===true?1:0,Y=w(y+E+C);h=s(h);var B,z,F,G={},K,A,D=[],T=b.p.altRows===true?b.p.altclass:"",H;b.p.page=o(a.jgrid.getAccessor(d,c.page),b.p.page);b.p.lastpage=o(a.jgrid.getAccessor(d,
c.total),1);b.p.records=o(a.jgrid.getAccessor(d,c.records));b.p.userData=a.jgrid.getAccessor(d,c.userdata)||{};E&&(u=a.jgrid.getMethod("addSubGridCell"));F=b.p.keyIndex===false?a.isFunction(c.id)?c.id.call(b,d):c.id:b.p.keyIndex;if(!c.repeatitems){x=h;if(x.length>0&&!isNaN(F))F=b.p.keyName}z=a.jgrid.getAccessor(d,c.root);z==null&&a.isArray(d)&&(z=d);z||(z=[]);d=z.length;n=0;if(d>0&&b.p.page<=0)b.p.page=1;var O=parseInt(b.p.rowNum,10),P=b.p.scroll?a.jgrid.randId():1,R=false,S;g&&(O=O*(g+1));b.p.datatype===
"local"&&!b.p.deselectAfterSort&&(R=true);var J=a.isFunction(b.p.afterInsertRow),N=[],Q=false,aa;if(b.p.grouping){Q=b.p.groupingView.groupCollapse===true;aa=a.jgrid.getMethod("groupingPrepare")}for(;n<d;){g=z[n];A=a.jgrid.getAccessor(g,F);if(A===void 0){typeof F==="number"&&b.p.colModel[F+y+E+C]!=null&&(A=a.jgrid.getAccessor(g,b.p.colModel[F+y+E+C].name));if(A===void 0){A=P+n;if(x.length===0&&c.cell){m=a.jgrid.getAccessor(g,c.cell)||g;A=m!=null&&m[F]!==void 0?m[F]:A}}}A=b.p.idPrefix+A;m=e===1?0:e;
H=(m+n)%2===1?T:"";R&&(S=b.p.multiselect?a.inArray(A,b.p.selarrrow)!==-1:A===b.p.selrow);var M=D.length;D.push("");C&&D.push(r(0,n,b.p.page,b.p.rowNum));y&&D.push(t(A,C,n,S));E&&D.push(u.call(l,y+C,n+e));B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=Y)}for(p=0;p<B.length;p++){m=a.jgrid.getAccessor(g,B[p]);G[b.p.colModel[p+y+E+C].name]=m;D.push(q(A,m,p+y+E+C,n+e,g,G))}D[M]=I(A,Q,H,G,g,S);D.push("</tr>");if(b.p.grouping){N=aa.call(l,D,N,G,n);D=[]}if(j||b.p.treeGrid===
true){G._id_=a.jgrid.stripPref(b.p.idPrefix,A);b.p.data.push(G);b.p._index[G._id_]=b.p.data.length-1}if(b.p.gridview===false){a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(D.join(""));l.triggerHandler("jqGridAfterInsertRow",[A,G,g]);J&&b.p.afterInsertRow.call(b,A,G,g);D=[]}G={};k++;n++;if(k===O)break}if(b.p.gridview===true){K=b.p.treeANode>-1?b.p.treeANode:0;b.p.grouping?l.jqGrid("groupingRender",N,b.p.colModel.length):b.p.treeGrid===true&&K>0?a(b.rows[K]).after(D.join("")):a("#"+a.jgrid.jqID(b.p.id)+
" tbody:first").append(D.join(""))}if(b.p.subGrid===true)try{l.jqGrid("addSubGrid",y+C)}catch(V){}b.p.totaltime=new Date-i;if(k>0&&b.p.records===0)b.p.records=d;if(b.p.treeGrid===true)try{l.jqGrid("setTreeNode",K+1,k+K+1)}catch(Z){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=k;b.p.treeANode=-1;b.p.userDataOnFooter&&l.jqGrid("footerData","set",b.p.userData,true);if(j){b.p.records=d;b.p.lastpage=Math.ceil(d/O)}f||b.updatepager(false,true);if(j)for(;k<d&&z[k];){g=z[k];A=a.jgrid.getAccessor(g,
F);if(A===void 0){typeof F==="number"&&b.p.colModel[F+y+E+C]!=null&&(A=a.jgrid.getAccessor(g,b.p.colModel[F+y+E+C].name));if(A===void 0){A=P+k;if(x.length===0&&c.cell){e=a.jgrid.getAccessor(g,c.cell)||g;A=e!=null&&e[F]!==void 0?e[F]:A}}}if(g){A=b.p.idPrefix+A;B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=Y)}for(p=0;p<B.length;p++)G[b.p.colModel[p+y+E+C].name]=a.jgrid.getAccessor(g,B[p]);G._id_=a.jgrid.stripPref(b.p.idPrefix,A);b.p.data.push(G);b.p._index[G._id_]=
b.p.data.length-1;G={}}k++}}},A=function(){function d(a){var b=0,c,e,f,i,h;if(a.groups!=null){(e=a.groups.length&&a.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(c=0;c<a.groups.length;c++){b>0&&e&&p.or();try{d(a.groups[c])}catch(j){alert(j)}b++}e&&p.orEnd()}if(a.rules!=null)try{(f=a.rules.length&&a.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(c=0;c<a.rules.length;c++){h=a.rules[c];i=a.groupOp.toString().toUpperCase();if(q[h.op]&&h.field){b>0&&i&&i==="OR"&&(p=p.or());p=q[h.op](p,
i)(h.field,h.data,g[h.field])}b++}f&&p.orEnd()}catch(l){alert(l)}}var c=b.p.multiSort?[]:"",e=[],f=false,g={},i=[],h=[],j,l,k;if(a.isArray(b.p.data)){var m=b.p.grouping?b.p.groupingView:false,n,o;a.each(b.p.colModel,function(){l=this.sorttype||"text";if(l==="date"||l==="datetime"){if(this.formatter&&typeof this.formatter==="string"&&this.formatter==="date"){j=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat;k=this.formatoptions&&this.formatoptions.newformat?
this.formatoptions.newformat:a.jgrid.formatter.date.newformat}else j=k=this.datefmt||"Y-m-d";g[this.name]={stype:l,srcfmt:j,newfmt:k}}else g[this.name]={stype:l,srcfmt:"",newfmt:""};if(b.p.grouping){o=0;for(n=m.groupField.length;o<n;o++)if(this.name===m.groupField[o]){var d=this.name;if(this.index)d=this.index;i[o]=g[d];h[o]=d}}if(b.p.multiSort){if(this.lso){c.push(this.name);d=this.lso.split("-");e.push(d[d.length-1])}}else if(!f&&(this.index===b.p.sortname||this.name===b.p.sortname)){c=this.name;
f=true}});if(b.p.treeGrid)a(b).jqGrid("SortTree",c,b.p.sortorder,g[c].stype||"text",g[c].srcfmt||"");else{var q={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},cn:function(a){return a.contains},nc:function(a,b){return b==="OR"?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,b){return b==="OR"?a.orNot().startsWith:
a.andNot().startsWith},en:function(a,b){return b==="OR"?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return b==="OR"?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return b==="OR"?a.orNot().isNull:a.andNot().isNull}},p=a.jgrid.from(b.p.data);b.p.ignoreCase&&(p=p.ignoreCase());if(b.p.search===true){var s=b.p.postData.filters;if(s){typeof s==="string"&&(s=a.jgrid.parse(s));d(s)}else try{p=
q[b.p.postData.searchOper](p)(b.p.postData.searchField,b.p.postData.searchString,g[b.p.postData.searchField])}catch(t){}}if(b.p.grouping)for(o=0;o<n;o++)p.orderBy(h[o],m.groupOrder[o],i[o].stype,i[o].srcfmt);b.p.multiSort?a.each(c,function(a){p.orderBy(this,e[a],g[this].stype,g[this].srcfmt)}):c&&b.p.sortorder&&f&&(b.p.sortorder.toUpperCase()==="DESC"?p.orderBy(b.p.sortname,"d",g[c].stype,g[c].srcfmt):p.orderBy(b.p.sortname,"a",g[c].stype,g[c].srcfmt));var s=p.select(),r=parseInt(b.p.rowNum,10),x=
s.length,y=parseInt(b.p.page,10),E=Math.ceil(x/r),v={},s=s.slice((y-1)*r,y*r),g=p=null;v[b.p.localReader.total]=E;v[b.p.localReader.page]=y;v[b.p.localReader.records]=x;v[b.p.localReader.root]=s;v[b.p.localReader.userdata]=b.p.userData;s=null;return v}}},u=function(){b.grid.hDiv.loading=true;if(!b.p.hiddengrid)switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).show();a("#load_"+a.jgrid.jqID(b.p.id)).show()}},D=function(){b.grid.hDiv.loading=
false;switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).hide();a("#load_"+a.jgrid.jqID(b.p.id)).hide()}},z=function(d){if(!b.grid.hDiv.loading){var c=b.p.scroll&&d===false,e={},f,g=b.p.prmNames;if(b.p.page<=0)b.p.page=Math.min(1,b.p.lastpage);if(g.search!==null)e[g.search]=b.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=b.p.rowNum;if(g.page!==null)e[g.page]=b.p.page;if(g.sort!==null)e[g.sort]=
b.p.sortname;if(g.order!==null)e[g.order]=b.p.sortorder;if(b.p.rowTotal!==null&&g.totalrows!==null)e[g.totalrows]=b.p.rowTotal;var i=a.isFunction(b.p.loadComplete),h=i?b.p.loadComplete:null,j=0,d=d||1;if(d>1)if(g.npage!==null){e[g.npage]=d;j=d-1;d=1}else h=function(a){b.p.page++;b.grid.hDiv.loading=false;i&&b.p.loadComplete.call(b,a);z(d-1)};else g.npage!==null&&delete b.p.postData[g.npage];if(b.p.grouping){a(b).jqGrid("groupingSetup");var l=b.p.groupingView,k,m="";for(k=0;k<l.groupField.length;k++){var n=
l.groupField[k];a.each(b.p.colModel,function(a,b){if(b.name===n&&b.index)n=b.index});m=m+(n+" "+l.groupOrder[k]+", ")}e[g.sort]=m+e[g.sort]}a.extend(b.p.postData,e);var o=!b.p.scroll?1:b.rows.length-1,e=a(b).triggerHandler("jqGridBeforeRequest");if(!(e===false||e==="stop"))if(a.isFunction(b.p.datatype))b.p.datatype.call(b,b.p.postData,"load_"+b.p.id,o,d,j);else{if(a.isFunction(b.p.beforeRequest)){e=b.p.beforeRequest.call(b);e===void 0&&(e=true);if(e===false)return}f=b.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:b.p.url,
type:b.p.mtype,dataType:f,data:a.isFunction(b.p.serializeGridData)?b.p.serializeGridData.call(b,b.p.postData):b.p.postData,success:function(e,g,i){if(a.isFunction(b.p.beforeProcessing)&&b.p.beforeProcessing.call(b,e,g,i)===false)D();else{f==="xml"?x(e,b.grid.bDiv,o,d>1,j):C(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);c&&b.grid.populateVisible();if(b.p.loadonce||b.p.treeGrid)b.p.datatype="local";d===1&&D()}},
error:function(c,e,f){a.isFunction(b.p.loadError)&&b.p.loadError.call(b,c,e,f);d===1&&D()},beforeSend:function(d,c){var e=true;a.isFunction(b.p.loadBeforeSend)&&(e=b.p.loadBeforeSend.call(b,d,c));e===void 0&&(e=true);if(e===false)return false;u()}},a.jgrid.ajaxOptions,b.p.ajaxGridOptions));break;case "xmlstring":u();e=typeof b.p.datastr!=="string"?b.p.datastr:a.parseXML(b.p.datastr);x(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",
[e]);b.p.datatype="local";b.p.datastr=null;D();break;case "jsonstring":u();e=typeof b.p.datastr==="string"?a.jgrid.parse(b.p.datastr):b.p.datastr;C(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;D();break;case "local":case "clientside":u();b.p.datatype="local";e=A();C(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",
[e]);c&&b.grid.populateVisible();D()}}}},N=function(d){a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.hDiv)[b.p.useProp?"prop":"attr"]("checked",d);if(b.p.frozenColumns&&b.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.fhDiv)[b.p.useProp?"prop":"attr"]("checked",d)},V=function(d,c){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",g="",h,j,l,k,m=function(d){var c;a.isFunction(b.p.onPaging)&&(c=b.p.onPaging.call(b,d));if(c==="stop")return false;
b.p.selrow=null;if(b.p.multiselect){b.p.selarrrow=[];N(false)}b.p.savedRow=[];return true},d=d.substr(1),c=c+("_"+d);h="pg_"+d;j=d+"_left";l=d+"_center";k=d+"_right";a("#"+a.jgrid.jqID(d)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+j+"' align='left'></td><td id='"+l+"' align='center' style='white-space:pre;'></td><td id='"+k+"' align='right'></td></tr></tbody></table></div>").attr("dir",
...
"last"+c&&h){b.p.page=d;e=true}e&&z();return false})}b.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(d){if((d.charCode||d.keyCode||0)===13){if(!m("user"))return false;a(this).val(o(a(this).val(),1));b.p.page=a(this).val()>0?a(this).val():b.p.page;z();return false}return this})},X=function(d,c){var e,f="",g=b.p.colModel,i=false,h;h=b.p.frozenColumns?c:b.grid.headers[d].el;var j="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[d].lso)if(g[d].lso===
"asc"){g[d].lso=g[d].lso+"-desc";j="desc"}else if(g[d].lso==="desc"){g[d].lso=g[d].lso+"-asc";j="asc"}else{if(g[d].lso==="asc-desc"||g[d].lso==="desc-asc")g[d].lso=""}else g[d].lso=j=g[d].firstsortorder||"asc";if(j){a("span.s-ico",h).show();a("span.ui-icon-"+j,h).removeClass("ui-state-disabled");a(h).attr("aria-selected","true")}else b.p.viewsortcols[0]||a("span.s-ico",h).hide();b.p.sortorder="";a.each(g,function(a){if(this.lso){a>0&&i&&(f=f+", ");e=this.lso.split("-");f=f+(g[a].index||g[a].name);
f=f+(" "+e[e.length-1]);i=true;b.p.sortorder=e[e.length-1]}});h=f.lastIndexOf(b.p.sortorder);f=f.substring(0,h);b.p.sortname=f},W=function(d,c,e,f,g){if(b.p.colModel[c].sortable&&!(b.p.savedRow.length>0)){if(!e){if(b.p.lastsort===c)if(b.p.sortorder==="asc")b.p.sortorder="desc";else{if(b.p.sortorder==="desc")b.p.sortorder="asc"}else b.p.sortorder=b.p.colModel[c].firstsortorder||"asc";b.p.page=1}if(b.p.multiSort)X(c,g);else{if(f){if(b.p.lastsort===c&&b.p.sortorder===f&&!e)return;b.p.sortorder=f}e=b.grid.headers[b.p.lastsort].el;
g=b.p.frozenColumns?g:b.grid.headers[c].el;a("span.ui-grid-ico-sort",e).addClass("ui-state-disabled");a(e).attr("aria-selected","false");if(b.p.frozenColumns){b.grid.fhDiv.find("span.ui-grid-ico-sort").addClass("ui-state-disabled");b.grid.fhDiv.find("th").attr("aria-selected","false")}a("span.ui-icon-"+b.p.sortorder,g).removeClass("ui-state-disabled");a(g).attr("aria-selected","true");if(!b.p.viewsortcols[0]&&b.p.lastsort!==c){b.p.frozenColumns&&b.grid.fhDiv.find("span.s-ico").hide();a("span.s-ico",
e).hide();a("span.s-ico",g).show()}d=d.substring(5+b.p.id.length+1);b.p.sortname=b.p.colModel[c].index||d}if(a(b).triggerHandler("jqGridSortCol",[b.p.sortname,c,b.p.sortorder])==="stop")b.p.lastsort=c;else if(a.isFunction(b.p.onSortCol)&&b.p.onSortCol.call(b,b.p.sortname,c,b.p.sortorder)==="stop")b.p.lastsort=c;else{if(b.p.datatype==="local")b.p.deselectAfterSort&&a(b).jqGrid("resetSelection");else{b.p.selrow=null;b.p.multiselect&&N(false);b.p.selarrrow=[];b.p.savedRow=[]}if(b.p.scroll){g=b.grid.bDiv.scrollLeft;
v.call(b,true,false);b.grid.hDiv.scrollLeft=g}b.p.subGrid&&b.p.datatype==="local"&&a("td.sgexpanded","#"+a.jgrid.jqID(b.p.id)).each(function(){a(this).trigger("click")});z();b.p.lastsort=c;if(b.p.sortname!==d&&c)b.p.lastsort=c}}},ca=function(d){d=a(b.grid.headers[d].el);d=[d.position().left+d.outerWidth()];b.p.direction==="rtl"&&(d[0]=b.p.width-d[0]);d[0]=d[0]-b.grid.bDiv.scrollLeft;d.push(a(b.grid.hDiv).position().top);d.push(a(b.grid.bDiv).offset().top-a(b.grid.hDiv).offset().top+a(b.grid.bDiv).height());
return d},$=function(d){var c,e=b.grid.headers,f=a.jgrid.getCellIndex(d);for(c=0;c<e.length;c++)if(d===e[c].el){f=c;break}return f};this.p.id=this.id;-1===a.inArray(b.p.multikey,["shiftKey","altKey","ctrlKey"])&&(b.p.multikey=!1);b.p.keyIndex=!1;b.p.keyName=!1;for(g=0;g<b.p.colModel.length;g++)b.p.colModel[g]=a.extend(!0,{},b.p.cmTemplate,b.p.colModel[g].template||{},b.p.colModel[g]),!1===b.p.keyIndex&&!0===b.p.colModel[g].key&&(b.p.keyIndex=g);b.p.sortorder=b.p.sortorder.toLowerCase();a.jgrid.cell_width=
a.jgrid.cellWidth();!0===b.p.grouping&&(b.p.scroll=!1,b.p.rownumbers=!1,b.p.treeGrid=!1,b.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(da){}"local"!==b.p.datatype&&(b.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(b).jqGrid("setSubGrid")}catch(ea){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?b.p.multiselectWidth+b.p.cellLayout:
...
b.p.jsonReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.jsonReader);b.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.localReader);b.p.scroll&&(b.p.pgbuttons=!1,b.p.pginput=!1,b.p.rowList=[]);b.p.data.length&&y();var E="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
Y,F,K,R,O,B,H,T,aa=T="",P=[],ha=[];F=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(g=b.p.colModel.length-1;0<=g;g--)if(!b.p.colModel[g].hidden){b.p.colModel[g].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(T=" ui-i-asc",aa=" ui-i-desc");Y=k?"class='ui-th-div-ie'":"";T="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+T+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+
aa+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");if(b.p.multiSort){P=b.p.sortname.split(",");for(g=0;g<P.length;g++)F=a.trim(P[g]).split(" "),P[g]=a.trim(F[0]),ha[g]=F[1]?a.trim(F[1]):b.p.sortorder||"asc"}for(g=0;g<this.p.colNames.length;g++)F=b.p.headertitles?' title="'+a.jgrid.stripHtml(b.p.colNames[g])+'"':"",E+="<th id='"+b.p.id+"_"+b.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+F+">",F=b.p.colModel[g].index||b.p.colModel[g].name,
E+="<div id='jqgh_"+b.p.id+"_"+b.p.colModel[g].name+"' "+Y+">"+b.p.colNames[g],b.p.colModel[g].width=b.p.colModel[g].width?parseInt(b.p.colModel[g].width,10):150,"boolean"!==typeof b.p.colModel[g].title&&(b.p.colModel[g].title=!0),b.p.colModel[g].lso="",F===b.p.sortname&&(b.p.lastsort=g),b.p.multiSort&&(F=a.inArray(F,P),-1!==F&&(b.p.colModel[g].lso=ha[F])),E+=T+"</div></th>";T=null;a(this).append(E+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
if(this.p.multiselect){var S=[],ba;a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){b.p.selarrrow=[];var d=b.p.frozenColumns===true?b.p.id+"_frozen":"";if(this.checked){a(b.rows).each(function(c){if(c>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",true);a(this).addClass("ui-state-highlight").attr("aria-selected","true");b.p.selarrrow.push(this.id);
b.p.selrow=this.id;if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",true);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).addClass("ui-state-highlight")}}});ba=true;S=[]}else{a(b.rows).each(function(c){if(c>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",false);a(this).removeClass("ui-state-highlight").attr("aria-selected",
"false");S.push(this.id);if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).removeClass("ui-state-highlight")}}});b.p.selrow=null;ba=false}a(b).triggerHandler("jqGridSelectAll",[ba?b.p.selarrrow:S,ba]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,ba?b.p.selarrrow:S,ba)})}!0===b.p.autowidth&&(E=a(m).innerWidth(),b.p.width=0<E?E:"nw");(function(){var d=0,c=a.jgrid.cell_width?0:o(b.p.cellLayout,
...
b.p.width){b.p.colModel[g].width=b.p.colModel[g].width-(b.p.tblwidth-parseInt(b.p.width,10));b.p.tblwidth=b.p.width}}})();a(m).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+b.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var E=a("thead:first",b).get(0),Q="";b.p.footerrow&&(Q+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
i+"'>");var j=a("tr:first",E),Z="<tr class='jqgfirstrow' role='row' style='height:auto'>";b.p.disableClick=!1;a("th",j).each(function(d){K=b.p.colModel[d].width;if(b.p.colModel[d].resizable===void 0)b.p.colModel[d].resizable=true;if(b.p.colModel[d].resizable){R=document.createElement("span");a(R).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else R="";a(this).css("width",K+"px").prepend(R);R=null;var c="";if(b.p.colModel[d].hidden){a(this).css("display",
"none");c="display:none;"}Z=Z+("<td role='gridcell' style='height:0px;width:"+K+"px;"+c+"'></td>");e.headers[d]={width:K,el:this};O=b.p.colModel[d].sortable;if(typeof O!=="boolean")O=b.p.colModel[d].sortable=true;c=b.p.colModel[d].name;c==="cb"||c==="subgrid"||c==="rn"||b.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");if(O)if(b.p.multiSort)if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();b.p.colModel[d].lso&&a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}else{if(b.p.colModel[d].lso){a("div span.s-ico",
this).show();a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}}else if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();d===b.p.lastsort&&a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}else if(d===b.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}b.p.footerrow&&(Q=Q+("<td role='gridcell' "+n(d,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(d){if(a(d.target).closest("th>span.ui-jqgrid-resize").length===
1){var c=$(this);if(b.p.forceFit===true){var f=b.p,g=c,i;for(i=c+1;i<b.p.colModel.length;i++)if(b.p.colModel[i].hidden!==true){g=i;break}f.nv=g-c}e.dragStart(c,d,ca(c));return false}}).click(function(d){if(b.p.disableClick)return b.p.disableClick=false;var c="th>div.ui-jqgrid-sortable",e,f;b.p.viewsortcols[2]||(c="th>div>span>span.ui-grid-ico-sort");d=a(d.target).closest(c);if(d.length===1){var g;if(b.p.frozenColumns){var i=a(this)[0].id.substring(b.p.id.length+1);a(b.p.colModel).each(function(a){if(this.name===
i){g=a;return false}})}else g=$(this);if(!b.p.viewsortcols[2]){e=true;f=d.attr("sort")}g!=null&&W(a("div",this)[0].id,g,e,f,this);return false}});if(b.p.sortable&&a.fn.sortable)try{a(b).jqGrid("sortableColumns",j)}catch(ja){}b.p.footerrow&&(Q+="</tr></tbody></table>");Z+="</tr>";this.appendChild(document.createElement("tbody"));a(this).addClass("ui-jqgrid-btable").append(Z);var Z=null,j=a("<table class='ui-jqgrid-htable' style='width:"+b.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+
"' cellspacing='0' cellpadding='0' border='0'></table>").append(E),M=b.p.caption&&!0===b.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>");E=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;M&&a(e.hDiv).hide();b.p.pager&&("string"===typeof b.p.pager?"#"!==b.p.pager.substr(0,1)&&(b.p.pager="#"+b.p.pager):b.p.pager="#"+a(b.p.pager).attr("id"),a(b.p.pager).css({width:e.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),M&&a(b.p.pager).hide(),V(b.p.pager,""));!1===b.p.cellEdit&&!0===b.p.hoverrows&&a(b).bind("mouseover",function(b){H=a(b.target).closest("tr.jqgrow");a(H).attr("class")!=="ui-subgrid"&&a(H).addClass("ui-state-hover")}).bind("mouseout",function(b){H=a(b.target).closest("tr.jqgrow");a(H).removeClass("ui-state-hover")});var J,U,fa;a(b).before(e.hDiv).click(function(d){B=d.target;H=a(B,b.rows).closest("tr.jqgrow");if(a(H).length===
0||H[0].className.indexOf("ui-state-disabled")>-1||(a(B,b).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==b.id)return this;var c=a(B).hasClass("cbox"),e=a(b).triggerHandler("jqGridBeforeSelectRow",[H[0].id,d]);(e=e===false||e==="stop"?false:true)&&a.isFunction(b.p.beforeSelectRow)&&(e=b.p.beforeSelectRow.call(b,H[0].id,d));if(!(B.tagName==="A"||(B.tagName==="INPUT"||B.tagName==="TEXTAREA"||B.tagName==="OPTION"||B.tagName==="SELECT")&&!c)&&e===true){J=H[0].id;U=a.jgrid.getCellIndex(B);
fa=a(B).closest("td,th").html();a(b).triggerHandler("jqGridCellSelect",[J,U,fa,d]);a.isFunction(b.p.onCellSelect)&&b.p.onCellSelect.call(b,J,U,fa,d);if(b.p.cellEdit===true)if(b.p.multiselect&&c)a(b).jqGrid("setSelection",J,true,d);else{J=H[0].rowIndex;try{a(b).jqGrid("editCell",J,U,true)}catch(f){}}else if(b.p.multikey)if(d[b.p.multikey])a(b).jqGrid("setSelection",J,true,d);else{if(b.p.multiselect&&c){c=a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+J).is(":checked");a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+J)[b.p.useProp?
...
false)}});b.p.selarrrow=[]}a(b).jqGrid("setSelection",J,true,d)}}}).bind("reloadGrid",function(d,c){if(b.p.treeGrid===true)b.p.datatype=b.p.treedatatype;c&&c.current&&b.grid.selectionPreserver(b);if(b.p.datatype==="local"){a(b).jqGrid("resetSelection");b.p.data.length&&y()}else if(!b.p.treeGrid){b.p.selrow=null;if(b.p.multiselect){b.p.selarrrow=[];N(false)}b.p.savedRow=[]}b.p.scroll&&v.call(b,true,false);if(c&&c.page){var e=c.page;if(e>b.p.lastpage)e=b.p.lastpage;e<1&&(e=1);b.p.page=e;b.grid.bDiv.scrollTop=
b.grid.prevRowHeight?(e-1)*b.grid.prevRowHeight*b.p.rowNum:0}if(b.grid.prevRowHeight&&b.p.scroll){delete b.p.lastpage;b.grid.populateVisible()}else b.grid.populate();b.p._inlinenav===true&&a(b).jqGrid("showAddEditButtons");return false}).dblclick(function(d){B=d.target;H=a(B,b.rows).closest("tr.jqgrow");if(a(H).length!==0){J=H[0].rowIndex;U=a.jgrid.getCellIndex(B);a(b).triggerHandler("jqGridDblClickRow",[a(H).attr("id"),J,U,d]);a.isFunction(b.p.ondblClickRow)&&b.p.ondblClickRow.call(b,a(H).attr("id"),
J,U,d)}}).bind("contextmenu",function(d){B=d.target;H=a(B,b.rows).closest("tr.jqgrow");if(a(H).length!==0){b.p.multiselect||a(b).jqGrid("setSelection",H[0].id,true,d);J=H[0].rowIndex;U=a.jgrid.getCellIndex(B);a(b).triggerHandler("jqGridRightClickRow",[a(H).attr("id"),J,U,d]);a.isFunction(b.p.onRightClickRow)&&b.p.onRightClickRow.call(b,a(H).attr("id"),J,U,d)}});e.bDiv=document.createElement("div");k&&"auto"===(""+b.p.height).toLowerCase()&&(b.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+
(k&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:b.p.height+(isNaN(b.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:b.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();b.p.multikey&&(a.jgrid.msie?a(e.bDiv).bind("selectstart",function(){return false}):a(e.bDiv).bind("mousedown",function(){return false}));M&&a(e.bDiv).hide();e.cDiv=
document.createElement("div");var ga=!0===b.p.hidegrid?a("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton' />").hover(function(){ga.addClass("ui-state-hover")},function(){ga.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"===i?"left":"right","0px"):"";a(e.cDiv).append(ga).append("<span class='ui-jqgrid-title"+("rtl"===i?"-rtl":"")+"'>"+b.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
a(e.cDiv).insertBefore(e.hDiv);b.p.toolbar[0]&&(e.uDiv=document.createElement("div"),"top"===b.p.toolbar[1]?a(e.uDiv).insertBefore(e.hDiv):"bottom"===b.p.toolbar[1]&&a(e.uDiv).insertAfter(e.hDiv),"both"===b.p.toolbar[1]?(e.ubDiv=document.createElement("div"),a(e.uDiv).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id).insertBefore(e.hDiv),a(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id).insertAfter(e.hDiv),M&&a(e.ubDiv).hide()):a(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id",
"t_"+this.id),M&&a(e.uDiv).hide());b.p.toppager&&(b.p.toppager=a.jgrid.jqID(b.p.id)+"_toppager",e.topDiv=a("<div id='"+b.p.toppager+"'></div>")[0],b.p.toppager="#"+b.p.toppager,a(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv),V(b.p.toppager,"_t"));b.p.footerrow&&(e.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],g=a("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>"),a(e.sDiv).append(g).width(e.width).insertAfter(e.hDiv),a(g).append(Q),e.footers=
a(".ui-jqgrid-ftable",e.sDiv)[0].rows[0].cells,b.p.rownumbers&&(e.footers[0].className="ui-state-default jqgrid-rownum"),M&&a(e.sDiv).hide());g=null;if(b.p.caption){var ia=b.p.datatype;!0===b.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",e.cDiv).click(function(d){var c=a.isFunction(b.p.onHeaderClick),f=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g,i=this;if(b.p.toolbar[0]===true){b.p.toolbar[1]==="both"&&(f=f+(", #"+a(e.ubDiv).attr("id")));f=f+(", #"+a(e.uDiv).attr("id"))}g=
a(f,"#gview_"+a.jgrid.jqID(b.p.id)).length;b.p.gridstate==="visible"?a(f,"#gbox_"+a.jgrid.jqID(b.p.id)).slideUp("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");b.p.gridstate="hidden";a("#gbox_"+a.jgrid.jqID(b.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(b.p.id)).hide();a(b).triggerHandler("jqGridHeaderClick",[b.p.gridstate,d]);c&&(M||b.p.onHeaderClick.call(b,b.p.gridstate,d))}}):b.p.gridstate===
"hidden"&&a(f,"#gbox_"+a.jgrid.jqID(b.p.id)).slideDown("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n");if(M){b.p.datatype=ia;z();M=false}b.p.gridstate="visible";a("#gbox_"+a.jgrid.jqID(b.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(b.p.id)).show();a(b).triggerHandler("jqGridHeaderClick",[b.p.gridstate,d]);c&&(M||b.p.onHeaderClick.call(b,b.p.gridstate,d))}});return false}),M&&(b.p.datatype=
"local",a(".ui-jqgrid-titlebar-close",e.cDiv).trigger("click")))}else a(e.cDiv).hide();a(e.hDiv).after(e.bDiv).mousemove(function(a){if(e.resizing){e.dragMove(a);return false}});a(".ui-jqgrid-labels",e.hDiv).bind("selectstart",function(){return false});a(document).bind("mouseup.jqGrid"+b.p.id,function(){if(e.resizing){e.dragEnd();return false}return true});b.formatCol=n;b.sortData=W;b.updatepager=function(d,c){var e,f,g,i,h,j,l,k="",m=b.p.pager?"_"+a.jgrid.jqID(b.p.pager.substr(1)):"",n=b.p.toppager?
...
b.p.pager||"";if(k=k+(b.p.toppager?k?","+b.p.toppager:b.p.toppager:"")){l=a.jgrid.formatter.integer||{};e=o(b.p.page);f=o(b.p.lastpage);a(".selbox",k)[this.p.useProp?"prop":"attr"]("disabled",false);if(b.p.pginput===true){a(".ui-pg-input",k).val(b.p.page);i=b.p.toppager?"#sp_1"+m+",#sp_1"+n:"#sp_1"+m;a(i).html(a.fmatter?a.fmatter.util.NumberFormat(b.p.lastpage,l):b.p.lastpage)}if(b.p.viewrecords)if(b.p.reccount===0)a(".ui-paging-info",k).html(b.p.emptyrecords);else{i=g+1;j=b.p.records;if(a.fmatter){i=
a.fmatter.util.NumberFormat(i,l);h=a.fmatter.util.NumberFormat(h,l);j=a.fmatter.util.NumberFormat(j,l)}a(".ui-paging-info",k).html(a.jgrid.format(b.p.recordtext,i,h,j))}if(b.p.pgbuttons===true){e<=0&&(e=f=0);if(e===1||e===0){a("#first"+m+", #prev"+m).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&a("#first_t"+n+", #prev_t"+n).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#first"+m+", #prev"+m).removeClass("ui-state-disabled");b.p.toppager&&a("#first_t"+
n+", #prev_t"+n).removeClass("ui-state-disabled")}if(e===f||e===0){a("#next"+m+", #last"+m).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&a("#next_t"+n+", #last_t"+n).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#next"+m+", #last"+m).removeClass("ui-state-disabled");b.p.toppager&&a("#next_t"+n+", #last_t"+n).removeClass("ui-state-disabled")}}}d===true&&b.p.rownumbers===true&&a(">td.jqgrid-rownum",b.rows).each(function(b){a(this).html(g+1+b)});c&&
b.p.jqgdnd&&a(b).jqGrid("gridDnD","updateDnD");a(b).triggerHandler("jqGridGridComplete");a.isFunction(b.p.gridComplete)&&b.p.gridComplete.call(b);a(b).triggerHandler("jqGridAfterGridComplete")};b.refreshIndex=y;b.setHeadCheckBox=N;b.constructTr=I;b.formatter=function(a,b,d,c,e){return p(a,b,d,c,e)};a.extend(e,{populate:z,emptyRows:v});this.grid=e;b.addXmlData=function(a){x(a,b.grid.bDiv)};b.addJSONData=function(a){C(a,b.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(b).triggerHandler("jqGridInitGrid");
...
this.name;var d=a.jgrid.getAccessor(e,f);void 0!==d&&(m[f]=this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?a.unformat.date.call(g,d,this):d,i=g.formatter(c,d,b,e,"edit"),h=this.title?{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f===g.p.ExpandColumn?a("td[role='gridcell']:eq("+b+") > span:first",j).html(i).attr(h):a("td[role='gridcell']:eq("+b+")",j).html(i).attr(h))}),"local"===g.p.datatype){var o=a.jgrid.stripPref(g.p.idPrefix,c),n=g.p._index[o],l;if(g.p.treeGrid)for(l in g.p.treeReader)g.p.treeReader.hasOwnProperty(l)&&
delete m[g.p.treeReader[l]];void 0!==n&&(g.p.data[n]=a.extend(!0,g.p.data[n],m));m=null}}catch(p){b=!1}b&&("string"===k?a(j).addClass(d):"object"===k&&a(j).css(d),a(g).triggerHandler("jqGridAfterGridComplete"))});return b},addRowData:function(c,e,d,f){d||(d="last");var b=!1,h,g,i,j,k,m,o,n,l="",p,q,t,r,s,w;e&&(a.isArray(e)?(p=!0,d="last",q=c):(e=[e],p=!1),this.each(function(){var v=e.length;k=this.p.rownumbers===true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!p)if(c!==void 0)c=
""+c;else{c=a.jgrid.randId();if(this.p.keyIndex!==false){q=this.p.colModel[this.p.keyIndex+i+j+k].name;e[0][q]!==void 0&&(c=e[0][q])}}t=this.p.altclass;for(var y=0,I="",x={},C=a.isFunction(this.p.afterInsertRow)?true:false;y<v;){r=e[y];g=[];if(p){try{c=r[q];c===void 0&&(c=a.jgrid.randId())}catch(A){c=a.jgrid.randId()}I=this.p.altRows===true?(this.rows.length-1)%2===0?t:"":""}w=c;c=this.p.idPrefix+c;if(k){l=this.formatCol(0,1,"",null,c,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+
l+">0</td>"}if(i){n='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+c+'" class="cbox"/>';l=this.formatCol(k,1,"",null,c,true);g[g.length]='<td role="gridcell" '+l+">"+n+"</td>"}j&&(g[g.length]=a(this).jqGrid("addSubGridCell",i+k,1));for(o=i+j+k;o<this.p.colModel.length;o++){s=this.p.colModel[o];h=s.name;x[h]=r[h];n=this.formatter(c,a.jgrid.getAccessor(r,h),o,r);l=this.formatCol(o,1,n,r,c,x);g[g.length]='<td role="gridcell" '+l+">"+n+"</td>"}g.unshift(this.constructTr(c,false,I,x,r,
...
a("td:eq("+f+")",b),{rowId:b.id,colModel:this.p.colModel[f]},f)}catch(h){d=a.jgrid.htmlDecode(a("td:eq("+f+")",b).html())}}});return d},getCol:function(c,e,d){var f=[],b,h=0,g,i,j,e="boolean"!==typeof e?!1:e;void 0===d&&(d=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(c)?a(this.p.colModel).each(function(a){if(this.name===c)return k=a,!1}):k=parseInt(c,10),0<=k)){var m=this.rows.length,o=0;if(m&&0<m){for(;o<m;){if(a(this.rows[o]).hasClass("jqgrow")){try{b=a.unformat.call(this,a(this.rows[o].cells[k]),
{rowId:this.rows[o].id,colModel:this.p.colModel[k]},k)}catch(n){b=a.jgrid.htmlDecode(this.rows[o].cells[k].innerHTML)}d?(j=parseFloat(b),h+=j,void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[o].id,value:b}):f.push(b)}o++}if(d)switch(d.toLowerCase()){case "sum":f=h;break;case "avg":f=h/m;break;case "count":f=m;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(c){return this.each(function(){if(this.grid){"boolean"!==typeof c&&(c=!1);if(this.p.deepempty)a("#"+
...
a||this.p.colModel[b].name===a){f=b;break}-1!==f&&(b=this.p.colModel[f].sortable,"boolean"!==typeof b&&(b=!0),"boolean"!==typeof e&&(e=!1),b&&this.sortData("jqgh_"+this.p.id+"_"+a,f,e,d))}})},clearBeforeUnload:function(){return this.each(function(){var c=this.grid;c.emptyRows.call(this,!0,!0);a(document).unbind("mouseup.jqGrid"+this.p.id);a(c.hDiv).unbind("mousemove");a(this).unbind();c.dragEnd=null;c.dragMove=null;c.dragStart=null;c.emptyRows=null;c.populate=null;c.populateVisible=null;c.scrollGrid=
null;c.selectionPreserver=null;c.bDiv=null;c.cDiv=null;c.hDiv=null;c.cols=null;var e,d=c.headers.length;for(e=0;e<d;e++)c.headers[e].el=null;this.addJSONData=this.addXmlData=this.formatter=this.constructTr=this.setHeadCheckBox=this.refreshIndex=this.updatepager=this.sortData=this.formatCol=null})},GridDestroy:function(){return this.each(function(){if(this.grid){this.p.pager&&a(this.p.pager).remove();try{a(this).jqGrid("clearBeforeUnload"),a("#gbox_"+a.jgrid.jqID(this.id)).remove()}catch(c){}}})},
GridUnload:function(){return this.each(function(){if(this.grid){var c=a(this).attr("id"),e=a(this).attr("class");this.p.pager&&a(this.p.pager).empty().removeClass("ui-state-default ui-jqgrid-pager corner-bottom");var d=document.createElement("table");a(d).attr({id:c});d.className=e;c=a.jgrid.jqID(this.id);a(d).removeClass("ui-jqgrid-btable");1===a(this.p.pager).parents("#gbox_"+c).length?(a(d).insertBefore("#gbox_"+c).show(),a(this.p.pager).insertBefore("#gbox_"+c)):a(d).insertBefore("#gbox_"+c).show();
a(this).jqGrid("clearBeforeUnload");a("#gbox_"+c).remove()}})},setGridState:function(c){return this.each(function(){this.grid&&("hidden"===c?(a(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv","#gview_"+a.jgrid.jqID(this.p.id)).slideUp("fast"),this.p.pager&&a(this.p.pager).slideUp("fast"),this.p.toppager&&a(this.p.toppager).slideUp("fast"),!0===this.p.toolbar[0]&&("both"===this.p.toolbar[1]&&a(this.grid.ubDiv).slideUp("fast"),a(this.grid.uDiv).slideUp("fast")),this.p.footerrow&&a(".ui-jqgrid-sdiv","#gbox_"+a.jgrid.jqID(this.p.id)).slideUp("fast"),
a(".ui-jqgrid-titlebar-close span",this.grid.cDiv).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),this.p.gridstate="hidden"):"visible"===c&&(a(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv","#gview_"+a.jgrid.jqID(this.p.id)).slideDown("fast"),this.p.pager&&a(this.p.pager).slideDown("fast"),this.p.toppager&&a(this.p.toppager).slideDown("fast"),!0===this.p.toolbar[0]&&("both"===this.p.toolbar[1]&&a(this.grid.ubDiv).slideDown("fast"),a(this.grid.uDiv).slideDown("fast")),this.p.footerrow&&
a(".ui-jqgrid-sdiv","#gbox_"+a.jgrid.jqID(this.p.id)).slideDown("fast"),a(".ui-jqgrid-titlebar-close span",this.grid.cDiv).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),this.p.gridstate="visible"))})},filterToolbar:function(c){c=a.extend({autosearch:!0,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,searchurl:"",stringResult:!1,groupOp:"AND",defaultSearch:"bw",searchOperators:!1,operandTitle:"Click to select search operation.",
operands:{eq:"==",ne:"!",lt:"<",le:"<=",gt:">",ge:">=",bw:"^",bn:"!^","in":"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#"}},a.jgrid.search,c||{});return this.each(function(){var e=this;if(!this.ftoolbar){var d=function(){var b={},d=0,f,h,m={},o;a.each(e.p.colModel,function(){var l=a("#gs_"+a.jgrid.jqID(this.name),!0===this.frozen&&!0===e.p.frozenColumns?e.grid.fhDiv:e.grid.hDiv);h=this.index||this.name;o=c.searchOperators?l.parent().prev().children("a").attr("soper")||c.defaultSearch:this.searchoptions&&
this.searchoptions.sopt?this.searchoptions.sopt[0]:"select"===this.stype?"eq":c.defaultSearch;if((f="custom"===this.stype&&a.isFunction(this.searchoptions.custom_value)&&0<l.length&&"SPAN"===l[0].nodeName.toUpperCase()?this.searchoptions.custom_value.call(e,l.children(".customelement:first"),"get"):l.val())||"nu"===o||"nn"===o)b[h]=f,m[h]=o,d++;else try{delete e.p.postData[h]}catch(n){}});var n=0<d?!0:!1;if(!0===c.stringResult||"local"===e.p.datatype){var l='{"groupOp":"'+c.groupOp+'","rules":[',
p=0;a.each(b,function(a,b){0<p&&(l+=",");l+='{"field":"'+a+'",';l+='"op":"'+m[a]+'",';l+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';p++});l+="]}";a.extend(e.p.postData,{filters:l});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,b);var q;e.p.searchurl&&(q=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var t="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?
!0:!1;!t&&a.isFunction(c.beforeSearch)&&(t=c.beforeSearch.call(e));t||a(e).jqGrid("setGridParam",{search:n}).trigger("reloadGrid",[{page:1}]);q&&a(e).jqGrid("setGridParam",{url:q});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(c.afterSearch)&&c.afterSearch.call(e)},f=function(b,f,h){a("#sopt_menu").remove();var f=parseInt(f,10),h=parseInt(h,10)+18,f='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'+(a(".ui-jqgrid-view").css("font-size")||"11px")+
";left:"+f+"px;top:"+h+'px;">',h=a(b).attr("soper"),k,m=[],o,n=0,l=a(b).attr("colname");for(k=e.p.colModel.length;n<k&&e.p.colModel[n].name!==l;)n++;n=e.p.colModel[n];l=a.extend({},n.searchoptions);l.sopt||(l.sopt=[],l.sopt[0]="select"===n.stype?"eq":c.defaultSearch);a.each(c.odata,function(){m.push(this.oper)});for(n=0;n<l.sopt.length;n++)o=a.inArray(l.sopt[n],m),-1!==o&&(k=h===c.odata[o].oper?"ui-state-highlight":"",f+='<li class="ui-menu-item '+k+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+
c.odata[o].oper+'" oper="'+c.operands[c.odata[o].oper]+'"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">'+c.operands[c.odata[o].oper]+"</td><td>"+c.odata[o].text+"</td></tr></table></a></li>");a("body").append(f+"</ul>");a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all");a("#sopt_menu > li > a").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).click(function(){var f=a(this).attr("value"),i=a(this).attr("oper");
a(e).triggerHandler("jqGridToolbarSelectOper",[f,i,b]);a("#sopt_menu").hide();a(b).text(i).attr("soper",f);if(c.autosearch===true){i=a(b).parent().next().children()[0];(a(i).val()||f==="nu"||f==="nn")&&d()}})},b=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;a.each(e.p.colModel,function(f){var i=this,j,k;k="";var m="=",o,n=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"'></th>"),l=a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
p=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");!0===this.hidden&&a(n).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");j=a.extend({},this.searchoptions||{});if(this.search){if(c.searchOperators){k=j.sopt?j.sopt[0]:"select"===i.stype?"eq":c.defaultSearch;for(o=0;o<c.odata.length;o++)if(c.odata[o].oper===k){m=c.operands[k]||"";break}k=
...
v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof v?v:v.message,a.jgrid.edit.bClose)}}}a(n).append(l);a(b).append(n);c.searchOperators||a("td:eq(0)",p).hide()});a("table thead",e.grid.hDiv).append(b);c.searchOperators&&(a(".soptclass",b).click(function(b){var d=
...
true;if(a(this).val()===b){this.selected=true;return false}});if(b!==void 0){d[h]=b;f++}else try{delete e.p.postData[h]}catch(g){}break;case "text":c.val(b);if(b!==void 0){d[h]=b;f++}else try{delete e.p.postData[h]}catch(l){}break;case "custom":a.isFunction(this.searchoptions.custom_value)&&c.length>0&&c[0].nodeName.toUpperCase()==="SPAN"&&this.searchoptions.custom_value.call(e,c.children(".customelement:first"),"set",b)}});var m=f>0?true:false;if(c.stringResult===true||e.p.datatype==="local"){var o=
'{"groupOp":"'+c.groupOp+'","rules":[',n=0;a.each(d,function(a,b){n>0&&(o=o+",");o=o+('{"field":"'+a+'",');o=o+'"op":"eq",';o=o+('"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}');n++});o=o+"]}";a.extend(e.p.postData,{filters:o});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,d);var l;if(e.p.searchurl){l=e.p.url;a(e).jqGrid("setGridParam",{url:e.p.searchurl})}var p=a(e).triggerHandler("jqGridToolbarBeforeClear")===
...
!1});a(c).bind("jqGridResizeStop.setFrozenColumns",function(b,d,e){b=a(".ui-jqgrid-htable",c.grid.fhDiv);a("th:eq("+e+")",b).width(d);b=a(".ui-jqgrid-btable",c.grid.fbDiv);a("tr:first td:eq("+e+")",b).width(d)});a(c).bind("jqGridSortCol.setFrozenColumns",function(b,d,e){b=a("tr.ui-jqgrid-labels:last th:eq("+c.p.lastsort+")",c.grid.fhDiv);d=a("tr.ui-jqgrid-labels:last th:eq("+e+")",c.grid.fhDiv);a("span.ui-grid-ico-sort",b).addClass("ui-state-disabled");a(b).attr("aria-selected","false");a("span.ui-icon-"+
...
"<a id='"+b.buttons[f].id+"' class='fm-button ui-state-default ui-corner-all'>"+b.buttons[f].text+"</a>";f=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px";e="<div id='info_id'>"+("<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+f+";"+("text-align:"+b.align+";")+"'>"+e+"</div>");e+=d?"<div class='ui-widget-content ui-helper-clearfix' style='text-align:"+b.buttonalign+";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button ui-state-default ui-corner-all'>"+
...
h.append(y);var I=a("<select></select>"),x,C=[];y.append(I);I.bind("change",function(){b.field=a(I).val();r=a(this).parents("tr:first");for(k=0;k<c.p.columns.length;k++)if(c.p.columns[k].name===b.field){s=c.p.columns[k];break}if(s){s.searchoptions.id=a.jgrid.randId();e&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var d=a.jgrid.createEl.call(g,s.inputtype,s.searchoptions,"",!0,c.p.ajaxSelectOptions,!0);a(d).addClass("input-elm");t=s.searchoptions.sopt?s.searchoptions.sopt:
c.p.sopt?c.p.sopt:-1!==a.inArray(s.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;var f="",h=0;C=[];a.each(c.p.ops,function(){C.push(this.oper)});for(k=0;k<t.length;k++)x=a.inArray(t[k],C),-1!==x&&(0===h&&(b.op=c.p.ops[x].oper),f+="<option value='"+c.p.ops[x].oper+"'>"+c.p.ops[x].text+"</option>",h++);a(".selectopts",r).empty().append(f);a(".selectopts",r)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",r)[0].offsetWidth,10)+1,a(".selectopts",r).width(f),a(".selectopts",
...
for(k=y=0;k<c.p.columns.length;k++){v=void 0===c.p.columns[k].search?!0:c.p.columns[k].search;var A=!0===c.p.columns[k].hidden;if(!0===c.p.columns[k].searchoptions.searchhidden&&v||v&&!A)v="",b.field===c.p.columns[k].name&&(v=" selected='selected'",y=k),w+="<option value='"+c.p.columns[k].name+"'"+v+">"+c.p.columns[k].label+"</option>"}I.append(w);w=a("<td class='operators'></td>");h.append(w);s=f.columns[y];s.searchoptions.id=a.jgrid.randId();e&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=
10);y=a.jgrid.createEl.call(g,s.inputtype,s.searchoptions,b.data,!0,c.p.ajaxSelectOptions,!0);if("nu"===b.op||"nn"===b.op)a(y).attr("readonly","true"),a(y).attr("disabled","true");var u=a("<select class='selectopts'></select>");w.append(u);u.bind("change",function(){b.op=a(u).val();r=a(this).parents("tr:first");var d=a(".input-elm",r)[0];if(b.op==="nu"||b.op==="nn"){b.data="";if(d.tagName.toUpperCase()!=="SELECT")d.value="";d.setAttribute("readonly","true");d.setAttribute("disabled","true")}else{if(d.tagName.toUpperCase()===
"SELECT")b.data=d.value;d.removeAttribute("readonly");d.removeAttribute("disabled")}c.onchange()});t=s.searchoptions.sopt?s.searchoptions.sopt:c.p.sopt?c.p.sopt:-1!==a.inArray(s.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;w="";a.each(c.p.ops,function(){C.push(this.oper)});for(k=0;k<t.length;k++)x=a.inArray(t[k],C),-1!==x&&(v=b.op===c.p.ops[x].oper?" selected='selected'":"",w+="<option value='"+c.p.ops[x].oper+"'"+v+">"+c.p.ops[x].text+"</option>");u.append(w);w=a("<td class='data'></td>");h.append(w);
w.append(y);a.jgrid.bindEv.call(g,y,s.searchoptions);a(y).addClass("input-elm").bind("change",function(){b.data=s.inputtype==="custom"?s.searchoptions.custom_value.call(g,a(this).children(".customelement:first"),"get"):a(this).val();c.onchange()});w=a("<td></td>");h.append(w);!0===this.p.ruleButtons&&(y=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),w.append(y),y.bind("click",function(){for(k=0;k<d.rules.length;k++)if(d.rules[k]===b){d.rules.splice(k,1);break}c.reDraw();
c.onchange();return false}));return h};this.getStringForGroup=function(a){var b="(",d;if(void 0!==a.groups)for(d=0;d<a.groups.length;d++){1<b.length&&(b+=" "+a.groupOp+" ");try{b+=this.getStringForGroup(a.groups[d])}catch(c){alert(c)}}if(void 0!==a.rules)try{for(d=0;d<a.rules.length;d++)1<b.length&&(b+=" "+a.groupOp+" "),b+=this.getStringForRule(a.rules[d])}catch(e){alert(e)}b+=")";return"()"===b?"":b};this.getStringForRule=function(b){var d="",c="",e,g;for(e=0;e<this.p.ops.length;e++)if(this.p.ops[e].oper===
b.op){d=this.p.operands.hasOwnProperty(b.op)?this.p.operands[b.op]:"";c=this.p.ops[e].oper;break}for(e=0;e<this.p.columns.length;e++)if(this.p.columns[e].name===b.field){g=this.p.columns[e];break}if(void 0===g)return"";e=b.data;if("bw"===c||"bn"===c)e+="%";if("ew"===c||"en"===c)e="%"+e;if("cn"===c||"nc"===c)e="%"+e+"%";if("in"===c||"ni"===c)e=" ("+e+")";f.errorcheck&&k(b.data,g);return-1!==a.inArray(g.searchtype,["int","integer","float","number","currency"])||"nn"===c||"nu"===c?b.field+" "+d+" "+
e:b.field+" "+d+' "'+e+'"'};this.resetFilter=function(){this.p.filter=a.extend(!0,{},this.p.initFilter);this.reDraw();this.onchange()};this.hideError=function(){a("th.ui-state-error",this).html("");a("tr.error",this).hide()};this.showError=function(){a("th.ui-state-error",this).html(this.p.errmsg);a("tr.error",this).show()};this.toUserFriendlyString=function(){return this.getStringForGroup(f.filter)};this.toString=function(){function a(d){var c="(",e;if(void 0!==d.groups)for(e=0;e<d.groups.length;e++)1<
c.length&&(c="OR"===d.groupOp?c+" || ":c+" && "),c+=a(d.groups[e]);if(void 0!==d.rules)for(e=0;e<d.rules.length;e++){1<c.length&&(c="OR"===d.groupOp?c+" || ":c+" && ");var f=d.rules[e];if(b.p.errorcheck){for(var g=void 0,h=void 0,g=0;g<b.p.columns.length;g++)if(b.p.columns[g].name===f.field){h=b.p.columns[g];break}h&&k(f.data,h)}c+=f.op+"(item."+f.field+",'"+f.data+"')"}c+=")";return"()"===c?"":c}var b=this;return a(this.p.filter)};this.reDraw();if(this.p.showQuery)this.onchange();this.filter=!0}}})};
...
h&&(h=!0);h&&a.isFunction(c.beforeShowSearch)&&(h=c.beforeShowSearch.call(f,d));h&&(a.jgrid.viewModal("#"+a.jgrid.jqID(i.themodal),{gbox:"#gbox_"+a.jgrid.jqID(b),jqm:c.jqModal,modal:c.modal,overlay:c.overlay,toTop:c.toTop}),a(f).triggerHandler("jqGridFilterAfterShow",[d]),a.isFunction(c.afterShowSearch)&&c.afterShowSearch.call(f,d))}var f=this;if(f.grid){var b="fbox_"+f.p.id,h=!0,g=!0,i={themodal:"searchmod"+b,modalhead:"searchhd"+b,modalcontent:"searchcnt"+b,scrollelm:b},j=f.p.postData[c.sFilter];
"string"===typeof j&&(j=a.jgrid.parse(j));!0===c.recreateFilter&&a("#"+a.jgrid.jqID(i.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(i.themodal))[0])d(a("#fbox_"+a.jgrid.jqID(+f.p.id)));else{var k=a("<div><div id='"+b+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),m="left",o="";"rtl"===f.p.direction&&(m="right",o=" style='text-align:left'",k.attr("dir","rtl"));var n=a.extend([],f.p.colModel),l="<a id='"+b+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+
c.Find+"</a>",p="<a id='"+b+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+c.Reset+"</a>",q="",t="",r,s=!1,w=-1;c.showQuery&&(q="<a id='"+b+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");c.columns.length?(n=c.columns,w=0,r=n[0].index||n[0].name):a.each(n,function(a,b){if(!b.label)b.label=f.p.colNames[a];if(!s){var d=
b.search===void 0?true:b.search,c=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&d||d&&!c){s=true;r=b.index||b.name;w=a}}});if(!j&&r||!1===c.multipleSearch){var v="eq";0<=w&&n[w].searchoptions&&n[w].searchoptions.sopt?v=n[w].searchoptions.sopt[0]:c.sopt&&c.sopt.length&&(v=c.sopt[0]);j={groupOp:"AND",rules:[{field:r,op:v,data:""}]}}s=!1;c.tmplNames&&c.tmplNames.length&&(s=!0,t=c.tmplLabel,t+="<select class='ui-template'>",t+="<option value='default'>Default</option>",a.each(c.tmplNames,
function(a,b){t=t+("<option value='"+a+"'>"+b+"</option>")}),t+="</select>");m="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+b+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+m+"'>"+p+t+"</td><td class='EditButton' "+o+">"+q+l+"</td></tr></tbody></table>";b=a.jgrid.jqID(b);a("#"+b).jqFilter({columns:n,filter:c.loadDefaults?j:null,showQuery:c.showQuery,errorcheck:c.errorcheck,sopt:c.sopt,
groupButton:c.multipleGroup,ruleButtons:c.multipleSearch,afterRedraw:c.afterRedraw,ops:c.odata,operands:c.operands,ajaxSelectOptions:f.p.ajaxSelectOptions,groupOps:c.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(c.afterChange)&&c.afterChange.call(f,a("#"+b),c)},direction:f.p.direction,id:f.p.id});k.append(m);s&&c.tmplFilters&&c.tmplFilters.length&&a(".ui-template",k).bind("change",function(){var d=a(this).val();d==="default"?a("#"+b).jqFilter("addFilter",
j):a("#"+b).jqFilter("addFilter",c.tmplFilters[parseInt(d,10)]);return false});!0===c.multipleGroup&&(c.multipleSearch=!0);a(f).triggerHandler("jqGridFilterInitialize",[a("#"+b)]);a.isFunction(c.onInitializeSearch)&&c.onInitializeSearch.call(f,a("#"+b));c.gbox="#gbox_"+b;c.layer?a.jgrid.createModal(i,k,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gbox_"+a.jgrid.jqID(f.p.id))[0],"#"+a.jgrid.jqID(c.layer),{position:"relative"}):a.jgrid.createModal(i,k,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gbox_"+a.jgrid.jqID(f.p.id))[0]);
(c.searchOnEnter||c.closeOnEscape)&&a("#"+a.jgrid.jqID(i.themodal)).keydown(function(d){var f=a(d.target);if(c.searchOnEnter&&d.which===13&&!f.hasClass("add-group")&&!f.hasClass("add-rule")&&!f.hasClass("delete-group")&&!f.hasClass("delete-rule")&&(!f.hasClass("fm-button")||!f.is("[id$=_query]"))){a("#"+b+"_search").focus().click();return false}if(c.closeOnEscape&&d.which===27){a("#"+a.jgrid.jqID(i.modalhead)).find(".ui-jqdialog-titlebar-close").focus().click();return false}});q&&a("#"+b+"_query").bind("click",
function(){a(".queryresult",k).toggle();return false});void 0===c.stringResult&&(c.stringResult=c.multipleSearch);a("#"+b+"_search").bind("click",function(){var d=a("#"+b),h={},j,k=d.jqFilter("filterData");if(c.errorcheck){d[0].hideError();c.showQuery||d.jqFilter("toSQLString");if(d[0].p.error){d[0].showError();return false}}if(c.stringResult){try{j=xmlJsonClass.toJson(k,"","",false)}catch(l){try{j=JSON.stringify(k)}catch(m){}}if(typeof j==="string"){h[c.sFilter]=j;a.each([c.sField,c.sValue,c.sOper],
function(){h[this]=""})}}else if(c.multipleSearch){h[c.sFilter]=k;a.each([c.sField,c.sValue,c.sOper],function(){h[this]=""})}else{h[c.sField]=k.rules[0].field;h[c.sValue]=k.rules[0].data;h[c.sOper]=k.rules[0].op;h[c.sFilter]=""}f.p.search=true;a.extend(f.p.postData,h);g=a(f).triggerHandler("jqGridFilterSearch");g===void 0&&(g=true);g&&a.isFunction(c.onSearch)&&(g=c.onSearch.call(f,f.p.filters));g!==false&&a(f).trigger("reloadGrid",[{page:1}]);c.closeAfterSearch&&a.jgrid.hideModal("#"+a.jgrid.jqID(i.themodal),
{gb:"#gbox_"+a.jgrid.jqID(f.p.id),jqm:c.jqModal,onClose:c.onClose});return false});a("#"+b+"_reset").bind("click",function(){var d={},h=a("#"+b);f.p.search=false;c.multipleSearch===false?d[c.sField]=d[c.sValue]=d[c.sOper]="":d[c.sFilter]="";h[0].resetFilter();s&&a(".ui-template",k).val("default");a.extend(f.p.postData,d);g=a(f).triggerHandler("jqGridFilterReset");g===void 0&&(g=true);g&&a.isFunction(c.onReset)&&(g=c.onReset.call(f));g!==false&&a(f).trigger("reloadGrid",[{page:1}]);c.closeAfterReset&&
a.jgrid.hideModal("#"+a.jgrid.jqID(i.themodal),{gb:"#gbox_"+a.jgrid.jqID(f.p.id),jqm:c.jqModal,onClose:c.onClose});return false});d(a("#"+b));a(".fm-button:not(.ui-state-disabled)",k).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")})}}})},editGridRow:function(e,d){d=a.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,
...
overlayClass:"ui-widget-overlay"},a.jgrid.edit,d||{});c[a(this)[0].p.id]=d;return this.each(function(){function f(){a(r+" > tbody > tr > td > .FormElement").each(function(){var b=a(".customelement",this);if(b.length){var d=a(b[0]).attr("name");a.each(l.p.colModel,function(){if(this.name===d&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(u[d]=this.editoptions.custom_value.call(l,a("#"+a.jgrid.jqID(d),r),"get"),void 0===u[d])throw"e1";}catch(b){"e1"===b?a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,b.message,a.jgrid.edit.bClose)}return!0}})}else{switch(a(this).get(0).type){case "checkbox":a(this).is(":checked")?u[this.name]=a(this).val():(b=a(this).attr("offval"),u[this.name]=b);break;case "select-one":u[this.name]=a("option:selected",this).val();break;case "select-multiple":u[this.name]=a(this).val();u[this.name]=u[this.name]?u[this.name].join(","):"";a("option:selected",this).each(function(b,
d){a(d).text()});break;case "password":case "text":case "textarea":case "button":u[this.name]=a(this).val()}l.p.autoencode&&(u[this.name]=a.jgrid.htmlEncode(u[this.name]))}});return!0}function b(b,d,e,f){var g,h,i,j=0,k,m,o,n=[],s=!1,p="",r;for(r=1;r<=f;r++)p+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(s=a(d).jqGrid("getInd",b));a(d.p.colModel).each(function(r){g=this.name;m=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":
"";if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===s)k="";else if(g===d.p.ExpandColumn&&!0===d.p.treeGrid)k=a("td[role='gridcell']:eq("+r+")",d.rows[s]).text();else{try{k=a.unformat.call(d,a("td[role='gridcell']:eq("+r+")",d.rows[s]),{rowId:b,colModel:this},r)}catch(t){k=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+r+")",d.rows[s]).text():a("td[role='gridcell']:eq("+r+")",d.rows[s]).html()}if(!k||"&nbsp;"===k||"&#160;"===k||1===k.length&&160===k.charCodeAt(0))k=
""}var x=a.extend({},this.editoptions||{},{id:g,name:g}),v=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),w=parseInt(v.rowpos,10)||j+1,y=parseInt(2*(parseInt(v.colpos,10)||1),10);"_empty"===b&&x.defaultValue&&(k=a.isFunction(x.defaultValue)?x.defaultValue.call(l):x.defaultValue);this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));o=a.jgrid.createEl.call(l,this.edittype,x,k,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[g]=k;a(o).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(o).addClass("ui-widget-content ui-corner-all");i=a(e).find("tr[rowpos="+w+"]");if(v.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+v.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=w}0===i.length&&(i=a("<tr "+m+" rowpos='"+w+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(p),a(e).append(i),
i[0].rp=w);a("td:eq("+(y-2)+")",i[0]).html(void 0===v.label?d.p.colNames[r]:v.label);a("td:eq("+(y-1)+")",i[0]).append(v.elmprefix).append(o).append(v.elmsuffix);"custom"===this.edittype&&a.isFunction(x.custom_value)&&x.custom_value.call(l,a("#"+g,"#"+q),"set",k);a.jgrid.bindEv.call(l,o,x);n[j]=r;j++}});if(0<j&&(r=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
b+"'/></td></tr>"),r[0].rp=j+999,a(e).append(r),c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate))c[l.p.id]._savedData[d.p.id+"_id"]=b;return n}function h(b,d,e){var f,g=0,h,i,j,k,m;if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData={},c[l.p.id]._savedData[d.p.id+"_id"]=b;var o=d.p.colModel;if("_empty"===b)a(o).each(function(){f=this.name;j=a.extend({},this.editoptions||{});if((i=a("#"+a.jgrid.jqID(f),"#"+e))&&i.length&&null!==i[0])if(k="","custom"===this.edittype&&a.isFunction(j.custom_value)?
j.custom_value.call(l,a("#"+f,"#"+e),"set",k):j.defaultValue?(k=a.isFunction(j.defaultValue)?j.defaultValue.call(l):j.defaultValue,"checkbox"===i[0].type?(m=k.toLowerCase(),0>m.search(/(false|f|0|no|n|off|undefined)/i)&&""!==m?(i[0].checked=!0,i[0].defaultChecked=!0,i[0].value=k):(i[0].checked=!1,i[0].defaultChecked=!1)):i.val(k)):"checkbox"===i[0].type?(i[0].checked=!1,i[0].defaultChecked=!1,k=a(i).attr("offval")):i[0].type&&"select"===i[0].type.substr(0,6)?i[0].selectedIndex=0:i.val(k),!0===c[l.p.id].checkOnSubmit||
c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[f]=k}),a("#id_g","#"+e).val(b);else{var n=a(d).jqGrid("getInd",b,!0);n&&(a('td[role="gridcell"]',n).each(function(i){f=o[i].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===o[i].editable){if(f===d.p.ExpandColumn&&!0===d.p.treeGrid)h=a(this).text();else try{h=a.unformat.call(d,a(this),{rowId:b,colModel:o[i]},i)}catch(j){h="textarea"===o[i].edittype?a(this).text():a(this).html()}l.p.autoencode&&(h=a.jgrid.htmlDecode(h));if(!0===c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[f]=
...
0<g&&a("#id_g",r).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&u.hasOwnProperty(b.name)&&""===u[b.name]&&(u[b.name]="null")})}function i(){var b,e=[!0,"",""],f={},i=l.p.prmNames,j,k,m,o,n,x=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+q),z]);x&&"object"===typeof x&&(u=x);a.isFunction(c[l.p.id].beforeCheckValues)&&(x=c[l.p.id].beforeCheckValues.call(l,u,a("#"+q),z))&&"object"===typeof x&&(u=x);for(m in u)if(u.hasOwnProperty(m)&&
(e=a.jgrid.checkValues.call(l,u[m],m),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[c[l.p.id],u,z]),void 0===f&&a.isFunction(c[l.p.id].onclickSubmit)&&(f=c[l.p.id].onclickSubmit.call(l,c[l.p.id],u,z)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",[u,a("#"+q),z]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(c[l.p.id].beforeSubmit)&&(e=c[l.p.id].beforeSubmit.call(l,u,a("#"+q),z)));if(e[0]&&!c[l.p.id].processing){c[l.p.id].processing=!0;a("#sData",r+"_2").addClass("ui-state-active");
k=i.oper;j=i.id;u[k]="_empty"===a.trim(u[l.p.id+"_id"])?i.addoper:i.editoper;u[k]!==i.addoper?u[j]=u[l.p.id+"_id"]:void 0===u[j]&&(u[j]=u[l.p.id+"_id"]);delete u[l.p.id+"_id"];u=a.extend(u,c[l.p.id].editData,f);if(!0===l.p.treeGrid)for(n in u[k]===i.addoper&&(o=a(l).jqGrid("getGridParam","selrow"),u["adjacency"===l.p.treeGridModel?l.p.treeReader.parent_id_field:"parent_id"]=o),l.p.treeReader)l.p.treeReader.hasOwnProperty(n)&&(f=l.p.treeReader[n],u.hasOwnProperty(f)&&!(u[k]===i.addoper&&"parent_id_field"===
n)&&delete u[f]);u[j]=a.jgrid.stripPref(l.p.idPrefix,u[j]);n=a.extend({url:c[l.p.id].url||a(l).jqGrid("getGridParam","editurl"),type:c[l.p.id].mtype,data:a.isFunction(c[l.p.id].serializeEditData)?c[l.p.id].serializeEditData.call(l,u):u,complete:function(f,g){var m;u[j]=l.p.idPrefix+u[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,z]);e[1]=a.isFunction(c[l.p.id].errorTextFormat)?c[l.p.id].errorTextFormat.call(l,f,z):g+" Status: '"+f.statusText+
"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,z]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(c[l.p.id].afterSubmit)&&(e=c[l.p.id].afterSubmit.call(l,f,u,z))}if(e[0]===false){a("#FormError>td",r).html(e[1]);a("#FormError",r).show()}else{l.p.autoencode&&a.each(u,function(b,d){u[b]=a.jgrid.htmlDecode(d)});if(u[k]===i.addoper){e[2]||(e[2]=a.jgrid.randId());u[j]=e[2];c[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",
e[2],o,u):a(l).jqGrid("addRowData",e[2],u,d.addedrow);if(c[l.p.id].closeAfterAdd){l.p.treeGrid!==true&&a(l).jqGrid("setSelection",e[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}else c[l.p.id].clearAfterAdd&&h("_empty",l,q)}else{if(c[l.p.id].reloadAfterSubmit){a(l).trigger("reloadGrid");c[l.p.id].closeAfterEdit||setTimeout(function(){a(l).jqGrid("setSelection",u[j])},1E3)}else l.p.treeGrid===true?a(l).jqGrid("setTreeRow",
u[j],u):a(l).jqGrid("setRowData",u[j],u);c[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}if(a.isFunction(c[l.p.id].afterComplete)){b=f;setTimeout(function(){a(l).triggerHandler("jqGridAddEditAfterComplete",[b,u,a("#"+q),z]);c[l.p.id].afterComplete.call(l,b,u,a("#"+q),z);b=null},500)}if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate){a("#"+q).data("disabled",false);if(c[l.p.id]._savedData[l.p.id+"_id"]!==
"_empty")for(m in c[l.p.id]._savedData)c[l.p.id]._savedData.hasOwnProperty(m)&&u[m]&&(c[l.p.id]._savedData[m]=u[m])}}c[l.p.id].processing=false;a("#sData",r+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+q)[0].focus()}catch(n){}}},a.jgrid.ajaxOptions,c[l.p.id].ajaxEditOptions);!n.url&&!c[l.p.id].useDataProxy&&(a.isFunction(l.p.dataProxy)?c[l.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(c[l.p.id].useDataProxy?(f=l.p.dataProxy.call(l,n,"set_"+l.p.id),void 0===
f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(n.data.oper===i.addoper&&c[l.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose}),n.data.oper===i.editoper&&c[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose}))):a.ajax(n))}!1===e[0]&&(a("#FormError>td",r).html(e[1]),a("#FormError",r).show())}
function j(a,b){var d=!1,c;for(c in a)if(a.hasOwnProperty(c)&&a[c]!=b[c]){d=!0;break}return d}function k(){var b=!0;a("#FormError",r).hide();if(c[l.p.id].checkOnUpdate&&(u={},f(),D=j(u,c[l.p.id]._savedData)))a("#"+q).data("disabled",!0),a(".confirm","#"+s.themodal).show(),b=!1;return b}function m(){var b;if("_empty"!==e&&void 0!==l.p.savedRow&&0<l.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<l.p.savedRow.length;b++)if(l.p.savedRow[b].id==e){a(l).jqGrid("restoreRow",e);break}}
function o(b,d){var c=d[1].length-1;0===b?a("#pData",r+"_2").addClass("ui-state-disabled"):void 0!==d[1][b-1]&&a("#"+a.jgrid.jqID(d[1][b-1])).hasClass("ui-state-disabled")?a("#pData",r+"_2").addClass("ui-state-disabled"):a("#pData",r+"_2").removeClass("ui-state-disabled");b===c?a("#nData",r+"_2").addClass("ui-state-disabled"):void 0!==d[1][b+1]&&a("#"+a.jgrid.jqID(d[1][b+1])).hasClass("ui-state-disabled")?a("#nData",r+"_2").addClass("ui-state-disabled"):a("#nData",r+"_2").removeClass("ui-state-disabled")}
function n(){var b=a(l).jqGrid("getDataIDs"),d=a("#id_g",r).val();return[a.inArray(d,b),b]}var l=this;if(l.grid&&e){var p=l.p.id,q="FrmGrid_"+p,t="TblGrid_"+p,r="#"+a.jgrid.jqID(t),s={themodal:"editmod"+p,modalhead:"edithd"+p,modalcontent:"editcnt"+p,scrollelm:q},w=a.isFunction(c[l.p.id].beforeShowForm)?c[l.p.id].beforeShowForm:!1,v=a.isFunction(c[l.p.id].afterShowForm)?c[l.p.id].afterShowForm:!1,y=a.isFunction(c[l.p.id].beforeInitData)?c[l.p.id].beforeInitData:!1,I=a.isFunction(c[l.p.id].onInitializeForm)?
c[l.p.id].onInitializeForm:!1,x=!0,C=1,A=0,u,D,z,q=a.jgrid.jqID(q);"new"===e?(e="_empty",z="add",d.caption=c[l.p.id].addCaption):(d.caption=c[l.p.id].editCaption,z="edit");!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(s.themodal))[0]&&a("#"+a.jgrid.jqID(s.themodal)).remove();var N=!0;d.checkOnUpdate&&d.jqModal&&!d.modal&&(N=!1);if(void 0!==a("#"+a.jgrid.jqID(s.themodal))[0]){x=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(q)),z]);void 0===x&&(x=!0);x&&y&&(x=y.call(l,a("#"+
q),z));if(!1===x)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(s.modalhead)).html(d.caption);a("#FormError",r).hide();c[l.p.id].topinfo?(a(".topinfo",r).html(c[l.p.id].topinfo),a(".tinfo",r).show()):a(".tinfo",r).hide();c[l.p.id].bottominfo?(a(".bottominfo",r+"_2").html(c[l.p.id].bottominfo),a(".binfo",r+"_2").show()):a(".binfo",r+"_2").hide();h(e,l,q);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData, #nData",r+"_2").hide():a("#pData, #nData",r+"_2").show();!0===c[l.p.id].processing&&(c[l.p.id].processing=
!1,a("#sData",r+"_2").removeClass("ui-state-active"));!0===a("#"+q).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(s.themodal)).hide(),a("#"+q).data("disabled",!1));a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),z]);w&&w.call(l,a("#"+q),z);a("#"+a.jgrid.jqID(s.themodal)).data("onClose",c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});N||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;
a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),z]);v&&v.call(l,a("#"+q),z)}else{var V=isNaN(d.dataheight)?d.dataheight:d.dataheight+"px",x=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",V=a("<form name='FormPost' id='"+q+"' class='FormGrid' onSubmit='return false;' style='width:"+x+";overflow:auto;position:relative;height:"+V+";'></form>").data("disabled",
!1),X=a("<table id='"+t+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),x=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+q),z]);void 0===x&&(x=!0);x&&y&&(x=y.call(l,a("#"+q),z));if(!1===x)return;m();a(l.p.colModel).each(function(){var a=this.formoptions;C=Math.max(C,a?a.colpos||0:0);A=Math.max(A,a?a.rowpos||0:0)});a(V).append(X);y=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*C+"'></td></tr>");y[0].rp=0;a(X).append(y);
y=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*C+"'>"+c[l.p.id].topinfo+"</td></tr>");y[0].rp=0;a(X).append(y);var x=(y="rtl"===l.p.direction?!0:!1)?"nData":"pData",W=y?"pData":"nData";b(e,l,X,C);var x="<a id='"+x+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",W="<a id='"+W+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",ca="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+
d.bSubmit+"</a>",$="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+d.bCancel+"</a>",t="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+t+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(y?W+x:x+W)+"</td><td class='EditButton'>"+ca+$+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+c[l.p.id].bottominfo+"</td></tr>"),t=t+"</tbody></table>";
if(0<A){var da=[];a.each(a(X)[0].rows,function(a,b){da[a]=b});da.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(da,function(b,d){a("tbody",X).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(p);var ea=!1;!0===d.closeOnEscape&&(d.closeOnEscape=!1,ea=!0);t=a("<div></div>").append(V).append(t);a.jgrid.createModal(s,t,d,"#gview_"+a.jgrid.jqID(l.p.id),a("#gbox_"+a.jgrid.jqID(l.p.id))[0]);y&&(a("#pData, #nData",r+"_2").css("float","right"),a(".EditButton",r+"_2").css("text-align","left"));c[l.p.id].topinfo&&
a(".tinfo",r).show();c[l.p.id].bottominfo&&a(".binfo",r+"_2").show();t=t=null;a("#"+a.jgrid.jqID(s.themodal)).keydown(function(b){var e=b.target;if(a("#"+q).data("disabled")===true)return false;if(c[l.p.id].savekey[0]===true&&b.which===c[l.p.id].savekey[1]&&e.tagName!=="TEXTAREA"){a("#sData",r+"_2").trigger("click");return false}if(b.which===27){if(!k())return false;ea&&a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:d.gbox,jqm:d.jqModal,onClose:c[l.p.id].onClose});return false}if(c[l.p.id].navkeys[0]===
true){if(a("#id_g",r).val()==="_empty")return true;if(b.which===c[l.p.id].navkeys[1]){a("#pData",r+"_2").trigger("click");return false}if(b.which===c[l.p.id].navkeys[2]){a("#nData",r+"_2").trigger("click");return false}}});d.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(s.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(s.themodal)).unbind("click").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+
a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false}));d.saveicon=a.extend([!0,"left","ui-icon-disk"],d.saveicon);d.closeicon=a.extend([!0,"left","ui-icon-close"],d.closeicon);!0===d.saveicon[0]&&a("#sData",r+"_2").addClass("right"===d.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+d.saveicon[2]+"'></span>");!0===d.closeicon[0]&&a("#cData",r+"_2").addClass("right"===d.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+
d.closeicon[2]+"'></span>");if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)ca="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bYes+"</a>",W="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bNo+"</a>",$="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bExit+"</a>",t=d.zIndex||999,t++,a("<div class='"+d.overlayClass+" jqgrid-overlay confirm' style='z-index:"+t+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+
(t+1)+"'>"+d.saveData+"<br/><br/>"+ca+W+$+"</div>").insertAfter("#"+q),a("#sNew","#"+a.jgrid.jqID(s.themodal)).click(function(){i();a("#"+q).data("disabled",false);a(".confirm","#"+a.jgrid.jqID(s.themodal)).hide();return false}),a("#nNew","#"+a.jgrid.jqID(s.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(s.themodal)).hide();a("#"+q).data("disabled",false);setTimeout(function(){a(":input:visible","#"+q)[0].focus()},0);return false}),a("#cNew","#"+a.jgrid.jqID(s.themodal)).click(function(){a(".confirm",
"#"+a.jgrid.jqID(s.themodal)).hide();a("#"+q).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+q),z]);I&&I.call(l,a("#"+q),z);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData,#nData",r+"_2").hide():a("#pData,#nData",r+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),z]);w&&w.call(l,a("#"+q),z);a("#"+a.jgrid.jqID(s.themodal)).data("onClose",
c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});N||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),z]);v&&v.call(l,a("#"+q),z);a(".fm-button","#"+a.jgrid.jqID(s.themodal)).hover(function(){a(this).addClass("ui-state-hover")},
function(){a(this).removeClass("ui-state-hover")});a("#sData",r+"_2").click(function(){u={};a("#FormError",r).hide();f();if(u[l.p.id+"_id"]==="_empty")i();else if(d.checkOnSubmit===true)if(D=j(u,c[l.p.id]._savedData)){a("#"+q).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(s.themodal)).show()}else i();else i();return false});a("#cData",r+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});
return false});a("#nData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var b=n();b[0]=parseInt(b[0],10);if(b[0]!==-1&&b[1][b[0]+1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+q),b[1][b[0]]]);var c;if(a.isFunction(d.onclickPgButtons)){c=d.onclickPgButtons.call(l,"next",a("#"+q),b[1][b[0]]);if(c!==void 0&&c===false)return false}if(a("#"+a.jgrid.jqID(b[1][b[0]+1])).hasClass("ui-state-disabled"))return false;h(b[1][b[0]+1],l,q);a(l).jqGrid("setSelection",
b[1][b[0]+1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+q),b[1][b[0]]]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(l,"next",a("#"+q),b[1][b[0]+1]);o(b[0]+1,b)}return false});a("#pData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var b=n();if(b[0]!==-1&&b[1][b[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+q),b[1][b[0]]]);var c;if(a.isFunction(d.onclickPgButtons)){c=d.onclickPgButtons.call(l,"prev",a("#"+
q),b[1][b[0]]);if(c!==void 0&&c===false)return false}if(a("#"+a.jgrid.jqID(b[1][b[0]-1])).hasClass("ui-state-disabled"))return false;h(b[1][b[0]-1],l,q);a(l).jqGrid("setSelection",b[1][b[0]-1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["prev",a("#"+q),b[1][b[0]]]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(l,"prev",a("#"+q),b[1][b[0]-1]);o(b[0]-1,b)}return false})}w=n();o(w[0],w)}})},viewGridRow:function(e,d){d=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",
...
i,h,j=0,k,l,m=[],o=!1,n,s="<td class='CaptionTD form-view-label ui-widget-content' width='"+d.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",p="",q=["integer","number","currency"],r=0,t=0,v,w,y;for(n=1;n<=f;n++)p+=1===n?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(c.p.colModel).each(function(){i=this.editrules&&!0===this.editrules.edithidden?!1:!0===
this.hidden?!0:!1;!i&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,q)?r=Math.max(r,parseInt(this.width,10)):t=Math.max(t,parseInt(this.width,10)))});v=0!==r?r:0!==t?t:0;o=a(c).jqGrid("getInd",b);a(c.p.colModel).each(function(b){g=this.name;w=!1;l=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";y="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&y){k=!1===o?"":g===c.p.ExpandColumn&&
!0===c.p.treeGrid?a("td:eq("+b+")",c.rows[o]).text():a("td:eq("+b+")",c.rows[o]).html();w="right"===this.align&&0!==v?!0:!1;var d=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),n=parseInt(d.rowpos,10)||j+1,s=parseInt(2*(parseInt(d.colpos,10)||1),10);if(d.rowabove){var q=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+d.rowcontent+"</td></tr>");a(e).append(q);q[0].rp=n}h=a(e).find("tr[rowpos="+n+"]");0===h.length&&(h=a("<tr "+l+" rowpos='"+n+"'></tr>").addClass("FormData").attr("id",
"trv_"+g),a(h).append(p),a(e).append(h),h[0].rp=n);a("td:eq("+(s-2)+")",h[0]).html("<b>"+(void 0===d.label?c.p.colNames[b]:d.label)+"</b>");a("td:eq("+(s-1)+")",h[0]).append("<span>"+k+"</span>").attr("id","v_"+g);w&&a("td:eq("+(s-1)+") span",h[0]).css({"text-align":"right",width:v+"px"});m[j]=b;j++}});0<j&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),
b[0].rp=j+99,a(e).append(b));return m}function h(b,d){var c,e,f=0,g,i;if(i=a(d).jqGrid("getInd",b,!0))a("td",i).each(function(b){c=d.p.colModel[b].name;e=d.p.colModel[b].editrules&&!0===d.p.colModel[b].editrules.edithidden?!1:!0===d.p.colModel[b].hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(g=c===d.p.ExpandColumn&&!0===d.p.treeGrid?a(this).text():a(this).html(),c=a.jgrid.jqID("v_"+c),a("#"+c+" span","#"+o).html(g),e&&a("#"+c,"#"+o).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+o).val(b)}
function g(b,d){var c=d[1].length-1;0===b?a("#pData","#"+o+"_2").addClass("ui-state-disabled"):void 0!==d[1][b-1]&&a("#"+a.jgrid.jqID(d[1][b-1])).hasClass("ui-state-disabled")?a("#pData",o+"_2").addClass("ui-state-disabled"):a("#pData","#"+o+"_2").removeClass("ui-state-disabled");b===c?a("#nData","#"+o+"_2").addClass("ui-state-disabled"):void 0!==d[1][b+1]&&a("#"+a.jgrid.jqID(d[1][b+1])).hasClass("ui-state-disabled")?a("#nData",o+"_2").addClass("ui-state-disabled"):a("#nData","#"+o+"_2").removeClass("ui-state-disabled")}
function i(){var b=a(j).jqGrid("getDataIDs"),d=a("#id_g","#"+o).val();return[a.inArray(d,b),b]}var j=this;if(j.grid&&e){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),o="ViewTbl_"+a.jgrid.jqID(k),n="ViewGrid_"+k,l="ViewTbl_"+k,p={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},q=a.isFunction(c[j.p.id].beforeInitData)?c[j.p.id].beforeInitData:!1,t=!0,r=1,s=0;!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(p.themodal))[0]&&a("#"+a.jgrid.jqID(p.themodal)).remove();if(void 0!==
a("#"+a.jgrid.jqID(p.themodal))[0]){q&&(t=q.call(j,a("#"+m)),void 0===t&&(t=!0));if(!1===t)return;a(".ui-jqdialog-title","#"+a.jgrid.jqID(p.modalhead)).html(d.caption);a("#FormError","#"+o).hide();h(e,j);a.isFunction(c[j.p.id].beforeShowForm)&&c[j.p.id].beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(p.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal});f()}else{var w=isNaN(d.dataheight)?d.dataheight:d.dataheight+"px",v=isNaN(d.datawidth)?
d.datawidth:d.datawidth+"px",n=a("<form name='FormPost' id='"+n+"' class='FormGrid' style='width:"+v+";overflow:auto;position:relative;height:"+w+";'></form>"),y=a("<table id='"+l+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");q&&(t=q.call(j,a("#"+m)),void 0===t&&(t=!0));if(!1===t)return;a(j.p.colModel).each(function(){var a=this.formoptions;r=Math.max(r,a?a.colpos||0:0);s=Math.max(s,a?a.rowpos||0:0)});a(n).append(y);b(e,j,y,r);
l="rtl"===j.p.direction?!0:!1;q="<a id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";t="<a id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";w="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+d.bClose+"</a>";if(0<s){var I=[];a.each(a(y)[0].rows,function(a,b){I[a]=b});I.sort(function(a,b){return a.rp>b.rp?1:a.rp<
b.rp?-1:0});a.each(I,function(b,d){a("tbody",y).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(k);n=a("<div></div>").append(n).append("<table border='0' class='EditTable' id='"+o+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+d.labelswidth+"'>"+(l?t+q:q+t)+"</td><td class='EditButton'>"+w+"</td></tr></tbody></table>");a.jgrid.createModal(p,n,d,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+o+"_2").css("float","right"),a(".EditButton","#"+
o+"_2").css("text-align","left"));d.viewPagerButtons||a("#pData, #nData","#"+o+"_2").hide();n=null;a("#"+p.themodal).keydown(function(b){if(b.which===27){c[j.p.id].closeOnEscape&&a.jgrid.hideModal("#"+a.jgrid.jqID(p.themodal),{gb:d.gbox,jqm:d.jqModal,onClose:d.onClose});return false}if(d.navkeys[0]===true){if(b.which===d.navkeys[1]){a("#pData","#"+o+"_2").trigger("click");return false}if(b.which===d.navkeys[2]){a("#nData","#"+o+"_2").trigger("click");return false}}});d.closeicon=a.extend([!0,"left",
"ui-icon-close"],d.closeicon);!0===d.closeicon[0]&&a("#cData","#"+o+"_2").addClass("right"===d.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+d.closeicon[2]+"'></span>");a.isFunction(d.beforeShowForm)&&d.beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(p.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,overlay:d.overlay,modal:d.modal});a(".fm-button:not(.ui-state-disabled)","#"+o+"_2").hover(function(){a(this).addClass("ui-state-hover")},
function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+o+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(p.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,onClose:d.onClose});return false});a("#nData","#"+o+"_2").click(function(){a("#FormError","#"+o).hide();var b=i();b[0]=parseInt(b[0],10);if(b[0]!==-1&&b[1][b[0]+1]){a.isFunction(d.onclickPgButtons)&&d.onclickPgButtons.call(j,"next",a("#"+m),b[1][b[0]]);h(b[1][b[0]+1],j);a(j).jqGrid("setSelection",b[1][b[0]+1]);a.isFunction(d.afterclickPgButtons)&&
d.afterclickPgButtons.call(j,"next",a("#"+m),b[1][b[0]+1]);g(b[0]+1,b)}f();return false});a("#pData","#"+o+"_2").click(function(){a("#FormError","#"+o).hide();var b=i();if(b[0]!==-1&&b[1][b[0]-1]){a.isFunction(d.onclickPgButtons)&&d.onclickPgButtons.call(j,"prev",a("#"+m),b[1][b[0]]);h(b[1][b[0]-1],j);a(j).jqGrid("setSelection",b[1][b[0]-1]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(j,"prev",a("#"+m),b[1][b[0]-1]);g(b[0]-1,b)}f();return false})}n=i();g(n[0],n)}})},delGridRow:function(e,
...
e){var b=a.isFunction(c[f.p.id].beforeShowForm),h=a.isFunction(c[f.p.id].afterShowForm),g=a.isFunction(c[f.p.id].beforeInitData)?c[f.p.id].beforeInitData:!1,i=f.p.id,j={},k=!0,m="DelTbl_"+a.jgrid.jqID(i),o,n,l,p,q="DelTbl_"+i,t={themodal:"delmod"+i,modalhead:"delhd"+i,modalcontent:"delcnt"+i,scrollelm:m};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){g&&(k=g.call(f,a("#"+m)),void 0===k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();
...
refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",position:"left",closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,alertwidth:200,alertheight:"auto",alerttop:null,alertleft:null,alertzIndex:null},a.jgrid.nav,d||{});return this.each(function(){if(!this.nav){var j={themodal:"alertmod_"+this.p.id,modalhead:"alerthd_"+this.p.id,modalcontent:"alertcnt_"+this.p.id},k=this,m;if(k.grid&&"string"===typeof c){void 0===a("#"+j.themodal)[0]&&(!d.alerttop&&!d.alertleft&&(void 0!==
window.innerWidth?(d.alertleft=window.innerWidth,d.alerttop=window.innerHeight):void 0!==document.documentElement&&void 0!==document.documentElement.clientWidth&&0!==document.documentElement.clientWidth?(d.alertleft=document.documentElement.clientWidth,d.alerttop=document.documentElement.clientHeight):(d.alertleft=1024,d.alerttop=768),d.alertleft=d.alertleft/2-parseInt(d.alertwidth,10)/2,d.alerttop=d.alerttop/2-25),a.jgrid.createModal(j,"<div>"+d.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",
{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqModal:!0,drag:!0,resize:!0,caption:d.alertcap,top:d.alerttop,left:d.alertleft,width:d.alertwidth,height:d.alertheight,closeOnEscape:d.closeOnEscape,zIndex:d.alertzIndex},"#gview_"+a.jgrid.jqID(k.p.id),a("#gbox_"+a.jgrid.jqID(k.p.id))[0],!0));var o=1,n,l=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},p=function(){a(this).removeClass("ui-state-hover")};d.cloneToTop&&k.p.toppager&&(o=2);for(n=0;n<o;n++){var q=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
t,r;0===n?(t=c,r=k.p.id,t===k.p.toppager&&(r+="_top",o=1)):(t=k.p.toppager,r=k.p.id+"_top");"rtl"===k.p.direction&&a(q).attr("dir","rtl").css("float","right");d.add&&(b=b||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+d.addicon+"'></span>"+d.addtext+"</div>"),a("tr",q).append(m),a(m,q).attr({title:d.addtitle||"",id:b.id||"add_"+r}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(d.addfunc)?d.addfunc.call(k):
...
r=a(m).jqGrid("getInd",c,!0);if(!1===r)return k;i=a.isFunction(j.beforeSaveRow)?j.beforeSaveRow.call(m,j,c):void 0;void 0===i&&(i=!0);if(i){i=a(r).attr("editable");j.url=j.url||m.p.editurl;if("1"===i){var s;a('td[role="gridcell"]',r).each(function(b){s=m.p.colModel[b];o=s.name;if("cb"!==o&&"subgrid"!==o&&!0===s.editable&&"rn"!==o&&!a(this).hasClass("not-editable-cell")){switch(s.edittype){case "checkbox":var d=["Yes","No"];s.editoptions&&(d=s.editoptions.value.split(":"));n[o]=a("input",this).is(":checked")?
d[0]:d[1];break;case "text":case "password":case "textarea":case "button":n[o]=a("input, textarea",this).val();break;case "select":if(s.editoptions.multiple){var d=a("select",this),c=[];n[o]=a(d).val();n[o]=n[o]?n[o].join(","):"";a("select option:selected",this).each(function(b,d){c[b]=a(d).text()});l[o]=c.join(",")}else n[o]=a("select option:selected",this).val(),l[o]=a("select option:selected",this).text();s.formatter&&"select"===s.formatter&&(l={});break;case "custom":try{if(s.editoptions&&a.isFunction(s.editoptions.custom_value)){if(n[o]=
...
(n[o]=a.jgrid.htmlEncode(n[o]));"clientArray"!==j.url&&s.editoptions&&!0===s.editoptions.NullIfEmpty&&""===n[o]&&(p[o]="null")}});if(!1===t[0]){try{var w=m.rows.namedItem(c),v=a.jgrid.findPos(w);a.jgrid.info_dialog(a.jgrid.errors.errcap,t[1],a.jgrid.edit.bClose,{left:v[0],top:v[1]+a(w).outerHeight()})}catch(y){alert(t[1])}return k}i=m.p.prmNames;w=c;v=!1===m.p.keyIndex?i.id:m.p.colModel[m.p.keyIndex+(!0===m.p.rownumbers?1:0)+(!0===m.p.multiselect?1:0)+(!0===m.p.subGrid?1:0)].name;if(n){n[i.oper]=
i.editoper;if(void 0===n[v]||""===n[v])n[v]=c;else if(r.id!==m.p.idPrefix+n[v]&&(i=a.jgrid.stripPref(m.p.idPrefix,c),void 0!==m.p._index[i]&&(m.p._index[n[v]]=m.p._index[i],delete m.p._index[i]),c=m.p.idPrefix+n[v],a(r).attr("id",c),m.p.selrow===w&&(m.p.selrow=c),a.isArray(m.p.selarrrow)&&(i=a.inArray(w,m.p.selarrrow),0<=i&&(m.p.selarrrow[i]=c)),m.p.multiselect))i="jqg_"+m.p.id+"_"+c,a("input.cbox",r).attr("id",i).attr("name",i);void 0===m.p.inlineData&&(m.p.inlineData={});n=a.extend({},n,m.p.inlineData,
j.extraparam)}if("clientArray"===j.url){n=a.extend({},n,l);m.p.autoencode&&a.each(n,function(b,d){n[b]=a.jgrid.htmlDecode(d)});i=a(m).jqGrid("setRowData",c,n);a(r).attr("editable","0");for(v=0;v<m.p.savedRow.length;v++)if(""+m.p.savedRow[v].id===""+w){q=v;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,i,n,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,i,j);k=!0;a(r).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(m.p.id)).show(),
p=a.extend({},n,p),p[v]=a.jgrid.stripPref(m.p.idPrefix,p[v]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,p):p,type:j.mtype,async:!1,complete:function(b,d){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,c,j]);a.isArray(f)||(f=[!0,n]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));a.isArray(f)?(e=f[0],n=f[1]||n):e=f;if(!0===e){m.p.autoencode&&a.each(n,function(b,
d){n[b]=a.jgrid.htmlDecode(d)});n=a.extend({},n,l);a(m).jqGrid("setRowData",c,n);a(r).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(""+m.p.savedRow[e].id===""+c){q=e;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,b,n,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,b);k=!0;a(r).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[c,b,d,null,j]),a.isFunction(j.errorfunc)&&j.errorfunc.call(m,
c,b,d,null),!0===j.restoreAfterError&&a(m).jqGrid("restoreRow",c,j.afterrestorefunc)}},error:function(b,d,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",[c,b,d,e,j]);if(a.isFunction(j.errorfunc))j.errorfunc.call(m,c,b,d,e);else{b=b.responseText||b.statusText;try{a.jgrid.info_dialog(a.jgrid.errors.errcap,'<div class="ui-state-error">'+b+"</div>",a.jgrid.edit.bClose,{buttonalign:"right"})}catch(f){alert(b)}}!0===j.restoreAfterError&&a(m).jqGrid("restoreRow",
...
b)c=d[a];else{var e=d[a].idx;if(0===e)c=d[a];else for(;0<=a;a--)if(d[a].idx===e-b){c=d[a];break}}return c}var f=this,b=f.p.groupingView,h="",g="",i,j,k=b.groupCollapse?b.plusicon:b.minusicon,m,o=[],n=b.groupField.length,k=k+(" tree-wrap-"+f.p.direction);a.each(f.p.colModel,function(a,d){var c;for(c=0;c<n;c++)if(b.groupField[c]===d.name){o[c]=a;break}});var l=0,p=a.makeArray(b.groupSummary);p.reverse();a.each(b.groups,function(q,t){l++;j=f.p.id+"ghead_"+t.idx;i=j+"_"+q;g="<span style='cursor:pointer;' class='ui-icon "+
k+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+i+"');return false;\"></span>";try{a.isArray(b.formatDisplayField)&&a.isFunction(b.formatDisplayField[t.idx])&&(t.displayValue=b.formatDisplayField[t.idx].call(f,t.displayValue,t.value,f.p.colModel[o[t.idx]],t.idx,b)),m=f.formatter(i,t.displayValue,o[t.idx],t.value)}catch(r){m=t.displayValue}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*t.idx+
'px;" colspan="'+e+'">'+g+a.jgrid.template(b.groupText[t.idx],m,t.cnt,t.summary)+"</td></tr>";if(n-1===t.idx){var s=b.groups[q+1],w,v,y=void 0!==s?b.groups[q+1].startRow:c.length;for(v=t.startRow;v<y;v++)h+=c[v].join("");var I;if(void 0!==s){for(I=0;I<b.groupField.length&&s.dataIndex!==b.groupField[I];I++);l=b.groupField.length-I}for(s=0;s<l;s++)if(p[s]){v="";b.groupCollapse&&!b.showSummaryOnHide&&(v=' style="display:none;"');h+="<tr"+v+' jqfootlevel="'+(t.idx-s)+'" role="row" class="ui-widget-content jqfoot ui-row-'+
f.p.direction+'">';v=d(q,s,b.groups);var x=f.p.colModel,C,A=v.cnt;for(w=0;w<e;w++){var u="<td "+f.formatCol(w,1,"")+">&#160;</td>",D="{0}";a.each(v.summary,function(){if(this.nm===x[w].name){x[w].summaryTpl&&(D=x[w].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v/=this.vd:this.v&&0<A&&(this.v/=A));try{C=f.formatter("",this.v,w,this)}catch(b){C=this.v}u="<td "+f.formatCol(w,1,"")+">"+a.jgrid.format(D,C)+"</td>";return!1}});h+=u}h+="</tr>"}l=I}});a("#"+
