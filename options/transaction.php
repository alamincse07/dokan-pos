...
$c_data_q ="select * from  customer_due_information   where  id = $id ";

//die($c_data_q);
$result=mysql_query($c_data_q);
...
$g->select_command = "SELECT  date,transaction_type,amount from  customer_transaction where  customer_id=$id ";

// this db table will be used for add,edit,delete
$g->table = "customer_transaction";
