...
class Mailchimp {
    ...
    public function __construct($apikey="288277c6e6ef14e0211236f1e8ced330-us8", $opts=array()) {
        #FYI: Commented to eliminate extra checking and put parameter on $apikey
        /*if (!$apikey) {
