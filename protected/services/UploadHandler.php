...
class UploadHandler
{
    ...
    function __construct($folder='') {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploaded/documents/admin/'.$folder.'/',
            'upload_url' => $this->get_full_url().'/uploaded/documents/admin/'.$folder.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->name=(microtime(true) * 10000).'@'.$file->name;
