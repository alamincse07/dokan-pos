...
SUM(CASE WHEN t.category = 'JSR' THEN 1 ELSE 0 END) AS JSR,
...
SUM(CASE WHEN t.category = 'JSR' THEN t.profit ELSE 0 END) AS JSR,
...
SUM(CASE WHEN t.category = 'JSR' THEN t.price ELSE 0 END) AS JSR,
