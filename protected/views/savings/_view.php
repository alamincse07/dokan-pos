...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('opend_date')); ?>:</b>
	<?php echo CHtml::encode($data->opend_date); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('last_taken')); ?>:</b>
	<?php echo CHtml::encode($data->last_taken); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('next_date')); ?>:</b>
	<?php echo CHtml::encode($data->next_date); ?>
	<br />
