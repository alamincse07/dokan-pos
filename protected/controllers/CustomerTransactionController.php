...
class CustomerTransactionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['CustomerTransaction'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['CustomerTransaction']))
			$model->attributes=$_GET['CustomerTransaction'];
	...
	{
		$model=CustomerTransaction::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='customer-transaction-form')
		{
