...
class m140714_101800_client_income extends CDbMigration
{
	/*public function up()
	{
	}
	...
	{
		echo "m140714_101800_income does not support migration down.\n";
		return false;
	}*/
    ...
    public function safeUp()
    {
        $this->execute("
                    ...
                    `social_security_type`  varchar(20) NULL ,
