...
class m140822_050607_company_settings extends CDbMigration
{
	/*public function up()
	{
	}
	...
	{
		echo "m140822_050607_company_settings does not support migration down.\n";
		return false;
	}*/
	...
	{
        $this->execute("CREATE TABLE `company_settings` (
