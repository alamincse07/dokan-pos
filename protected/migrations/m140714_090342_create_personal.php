...
class m140714_090342_create_personal extends CDbMigration
{
	/*public function up()
	{
	}
	...
	{
		echo "m140714_090342_create_personal does not support migration down.\n";
		return false;
	}*/
	...
	{
        $this->execute("CREATE TABLE `client_personal` (
                `id`  int(11) NOT NULL AUTO_INCREMENT ,
                `gender`  enum('Male','Female'),
                `client_id`  int(11) NULL ,
                `family_of_client`  int(11) NULL ,
                `default_advisor`  int(11) NULL ,
                `client_importance`  varchar(10) NULL ,
...
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
	...
	{
        $this->dropTable("client_personal");
	}
